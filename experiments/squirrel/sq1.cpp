...
int main(int argc, char **argv) {
  ...
  //  sqstd_register_bloblib(sq);             <- Valgrind complains about out of
  //  range memory access sqstd_register_iolib(sq);               <- Valgrind
  //  complains about out of range memory access
