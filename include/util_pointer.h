...
#define ptr_align_up(x, a)                                                     \
  ((ptr2int(x) + ((uintptr_t)(a) - (uintptr_t)1)) &                            \
   (~(((uintptr_t)(a)) - (uintptr_t)1)))
#define ptr_align_nearest(x, a)                                                \
  ((ptr2int(x) + ((uintptr_t)(a) >> (uintptr_t)1)) &                           \
   (~(((uintptr_t)(a)) - (uintptr_t)1)))
#define ptr_align_next(x, a)                                                   \
  ((ptr2int(x) + (uintptr_t)(a)) & (~(((uintptr_t)(a)) - (uintptr_t)1)))

#define alloca_aligned(s, a)                                                   \
  ((void *)ptr_align_up((void *)alloca((size_t)(s) + (size_t)(a) - (size_t)1), \
                        a))
