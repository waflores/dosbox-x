...
public:
  ...
  BX_NE2K_SMF void chipmem_write(uint32_t address, uint32_t value,
                                 unsigned io_len);
  BX_NE2K_SMF void asic_write(uint32_t address, uint32_t value,
                              unsigned io_len);
  BX_NE2K_SMF void page0_write(uint32_t address, uint32_t value,
                               unsigned io_len);
  BX_NE2K_SMF void page1_write(uint32_t address, uint32_t value,
                               unsigned io_len);
  BX_NE2K_SMF void page2_write(uint32_t address, uint32_t value,
                               unsigned io_len);
  BX_NE2K_SMF void page3_write(uint32_t address, uint32_t value,
                               unsigned io_len);
...
public:
  ...
  static uint32_t read_handler(void *this_ptr, uint32_t address,
                               unsigned io_len);
  static void write_handler(void *this_ptr, uint32_t address, uint32_t value,
                            unsigned io_len);
#if !BX_USE_NE2K_SMF
