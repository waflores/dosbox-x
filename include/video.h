...
#define GFX_NORMALSCALE                                                        \
  0x0200u // one of the Normal scalers and therefore should be ignored for
          // hardware scaling

#define GFX_SCALING 0x1000u
#define GFX_HARDWARE 0x2000u

#define GFX_CAN_RANDOM                                                         \
  0x4000u // If the interface can also do random access surface
