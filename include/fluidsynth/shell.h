 ...
 */
typedef int (*fluid_cmd_func_t)(void *data, int ac, char **av,
                                fluid_ostream_t out);
...
FLUIDSYNTH_API
void fluid_cmd_handler_set_synth(fluid_cmd_handler_t *handler,
                                 fluid_synth_t *synth);
 ...
 * @return Should return a new command handler for the connection
