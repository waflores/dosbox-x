...
/* NTS: Cannot make runtime configurable, because CB_MAX is used to define an
 * array */
#define CB_MAX 128U
#define CB_SIZE 32U
...
public:
  CALLBACK_HandlerObject() { vectorhandler.installed = false; }
  ...
  void Install(CallBack_Handler handler, Bitu type, PhysPt addr,
  ...
  uint16_t Get_callback() { return (uint16_t)m_callback; }
