...
#define windows_WAVE_FORMAT_VSELP                                              \
  0x0004 /* TODO: Pull out your old Windows CE HPC and record a sample */
...
#define windows_WAVE_FORMAT_VOXWARE_BYTE_ALIGNED                               \
...
#define windows_WAVE_FORMAT_VOXWARE_RT24                                       \
  0x0074 /* Voxware MetaVoice (obsolete) */
#define windows_WAVE_FORMAT_VOXWARE_RT29                                       \
  0x0075 /* Voxware MetaSound (obsolete) */
#define windows_WAVE_FORMAT_VOXWARE_RT29HW                                     \
...
#define windows_WAVE_FORMAT_ISIAUDIO_1401                                      \
  0x1401 /* ISIAudio (FIXME is this right?) */

#define windows_WAVE_FORMAT_SOUNDSPACE_MUSICOMPRESS                            \
