...
//!
//!              <a target="_blank"
//!              href="http://hackipedia.org/browse/Hardware/By%20company/Intel/8255,%20Programmable%20Peripheral%20Interface/8255A,%208255A-5%20Programmable%20Peripheral%20Interface%20(1991-08).pdf">Intel
//!              8255A datasheet</a>
//!
...
public:
  ...
  inline const char *getName(void) const { return nil_if_null(ppiName); }

public:
  //! \brief Retrieve the name of a pin on the chip related to port A, B, or C
  //! (what it's connected to) (for debug/UI purposes)
  inline const char *pinName(const unsigned int port,
...
public:
  ...
  bool IBF_B = false;
  //! Output Buffer Full, port A contains information for the external device
  //! (port A, Mode 1)
  bool OBF_A = false;
  //! Output Buffer Full, port B contains information for the external device
  //! (port B, Mode 1)
  bool OBF_B = false;
