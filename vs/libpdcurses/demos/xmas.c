...
WINDOW *treescrn, *treescrn2, *treescrn3, *treescrn4, *treescrn5, *treescrn6,
    *treescrn7, *treescrn8, *dotdeer0, *stardeer0, *lildeer0, *lildeer1,
    *lildeer2, *lildeer3, *middeer0, *middeer1, *middeer2, *middeer3, *bigdeer0,
    *bigdeer1, *bigdeer2, *bigdeer3, *bigdeer4, *lookdeer0, *lookdeer1,
...
void fromwho(void) { mvaddstr(21, 13, FROMWHO); }

void del_msg(void) { refresh(); }
...
#define TSHOW(win, pause)                                                      \
  touchwin(win);                                                               \
  wrefresh(win);                                                               \
  wrefresh(w_del_msg);                                                         \
  napms(pause)

#define SHOW(win, pause)                                                       \
