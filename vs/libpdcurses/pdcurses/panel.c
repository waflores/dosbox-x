...
PANEL *panel_below(const PANEL *pan) { return pan ? pan->below : _top_panel; }
...
const void *panel_userptr(const PANEL *pan) { return pan ? pan->user : NULL; }
...
int top_panel(PANEL *pan) { return show_panel(pan); }
