...
long MainWindow::onConnect(FXObject *sender, FXSelector sel, void *ptr)
{
...
long MainWindow::onDisconnect(FXObject *sender, FXSelector sel, void *ptr)
{
    hid_close(connected_device);
    connected_device = NULL;
...
long MainWindow::onRescan(FXObject *sender, FXSelector sel, void *ptr)
{
...
long MainWindow::onSendOutputReport(FXObject *sender, FXSelector sel, void *ptr)
{
    char buf[256];
    size_t data_len, len;
    int textfield_len;
...
long MainWindow::onSendFeatureReport(FXObject *sender, FXSelector sel, void *ptr)
{
    char buf[256];
    size_t data_len, len;
    int textfield_len;
...
long MainWindow::onGetFeatureReport(FXObject *sender, FXSelector sel, void *ptr)
{
    char buf[256];
    size_t len;
...
long MainWindow::onClear(FXObject *sender, FXSelector sel, void *ptr)
{
    input_text->setText("");
    return 1;
}

long MainWindow::onTimeout(FXObject *sender, FXSelector sel, void *ptr)
{
...
long MainWindow::onMacTimeout(FXObject *sender, FXSelector sel, void *ptr)
{
#ifdef __APPLE__
    check_apple_events();
