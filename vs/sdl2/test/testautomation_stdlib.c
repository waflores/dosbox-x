...
#define STRTOX_TEST_CASE(func_name, type, format_spec, str, base, expected_result, expected_endp_offset)                         \
    do {                                                                                                                         \
        const char *s = str;                                                                                                     \
...
{
#define STRTOD_TEST_CASE(str, expected_result, expected_endp_offset)                                        \
    do {                                                                                                    \
        const char *s = str;                                                                                \
