...
const SDL_version *SDL_Linked_Version(void) { return (&version); }
...
/* Exception handler to prevent the Audio thread hanging, making a zombie
 * process! */
...
BOOL APIENTRY _DllMainCRTStartup(HANDLE hModule, DWORD ul_reason_for_call,
                                 LPVOID lpReserved) {
