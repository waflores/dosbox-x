...
VideoBootStrap NX_bootstrap = {"nanox", "nanox", NX_Available, NX_CreateDevice};
...
static void create_aux_windows(_THIS) {
  ...
  GrSelectEvents(FSwindow,
                 (GR_EVENT_MASK_EXPOSURE | GR_EVENT_MASK_BUTTON_DOWN |
                  GR_EVENT_MASK_BUTTON_UP | GR_EVENT_MASK_FOCUS_IN |
                  GR_EVENT_MASK_FOCUS_OUT | GR_EVENT_MASK_KEY_DOWN |
                  GR_EVENT_MASK_KEY_UP | GR_EVENT_MASK_MOUSE_ENTER |
                  GR_EVENT_MASK_MOUSE_EXIT | GR_EVENT_MASK_MOUSE_MOTION |
...
static int NX_CreateWindow(_THIS, SDL_Surface *screen, int w, int h, int bpp,
                           Uint32 flags) {
...
SDL_Surface *NX_SetVideoMode(_THIS, SDL_Surface *current, int width, int height,
