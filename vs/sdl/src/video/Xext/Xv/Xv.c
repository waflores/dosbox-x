...
int SDL_NAME(XvQueryAdaptors)(Display *dpy, Window window,
...
int SDL_NAME(XvQueryEncodings)(Display *dpy, XvPortID port,
...
int SDL_NAME(XvPutVideo)(Display *dpy, XvPortID port, Drawable d, GC gc, int vx,
                         int vy, unsigned int vw, unsigned int vh, int dx,
                         int dy, unsigned int dw, unsigned int dh) {
  XExtDisplayInfo *info = xv_find_display(dpy);
  xvPutVideoReq *req;
...
int SDL_NAME(XvPutStill)(Display *dpy, XvPortID port, Drawable d, GC gc, int vx,
                         int vy, unsigned int vw, unsigned int vh, int dx,
                         int dy, unsigned int dw, unsigned int dh) {
  XExtDisplayInfo *info = xv_find_display(dpy);
  xvPutStillReq *req;
...
int SDL_NAME(XvGetVideo)(Display *dpy, XvPortID port, Drawable d, GC gc, int vx,
                         int vy, unsigned int vw, unsigned int vh, int dx,
                         int dy, unsigned int dw, unsigned int dh) {
  XExtDisplayInfo *info = xv_find_display(dpy);
  xvGetVideoReq *req;
...
int SDL_NAME(XvGetStill)(Display *dpy, XvPortID port, Drawable d, GC gc, int vx,
                         int vy, unsigned int vw, unsigned int vh, int dx,
                         int dy, unsigned int dw, unsigned int dh) {
  XExtDisplayInfo *info = xv_find_display(dpy);
  xvGetStillReq *req;
...
int SDL_NAME(XvSelectVideoNotify)(Display *dpy, Drawable drawable, Bool onoff) {
  XExtDisplayInfo *info = xv_find_display(dpy);
...
int SDL_NAME(XvSetPortAttribute)(Display *dpy, XvPortID port, Atom attribute,
                                 int value) {
  XExtDisplayInfo *info = xv_find_display(dpy);
...
int SDL_NAME(XvGetPortAttribute)(Display *dpy, XvPortID port, Atom attribute,
                                 int *p_value) {
  XExtDisplayInfo *info = xv_find_display(dpy);
...
int SDL_NAME(XvQueryBestSize)(Display *dpy, XvPortID port, Bool motion,
                              unsigned int vid_w, unsigned int vid_h,
                              unsigned int drw_w, unsigned int drw_h,
...
SDL_NAME(XvAttribute) *
  ...
  *num = 0;
  ...
  if (rep.num_attributes) {
    int size =
        (rep.num_attributes * sizeof(SDL_NAME(XvAttribute))) + rep.text_size;
...
SDL_NAME(XvImageFormatValues) *
    SDL_NAME(XvListImageFormats)(Display *dpy, XvPortID port, int *num) {
  XExtDisplayInfo *info = xv_find_display(dpy);
...
SDL_NAME(XvImage) * SDL_NAME(XvCreateImage)(Display *dpy, XvPortID port, int id,
  ...
  if ((ret = (SDL_NAME(XvImage) *)Xmalloc(sizeof(SDL_NAME(XvImage)) +
                                          (rep.num_planes << 3)))) {
    ret->id = id;
    ret->width = rep.width;
...
SDL_NAME(XvImage) * SDL_NAME(XvShmCreateImage)(Display *dpy, XvPortID port,
                                               int id, char *data, int width,
                                               int height,
...
int SDL_NAME(XvPutImage)(Display *dpy, XvPortID port, Drawable d, GC gc,
                         SDL_NAME(XvImage) * image, int src_x, int src_y,
                         unsigned int src_w, unsigned int src_h, int dest_x,
                         int dest_y, unsigned int dest_w, unsigned int dest_h) {
  XExtDisplayInfo *info = xv_find_display(dpy);
  xvPutImageReq *req;
  int len;
...
int SDL_NAME(XvShmPutImage)(Display *dpy, XvPortID port, Drawable d, GC gc,
                            SDL_NAME(XvImage) * image, int src_x, int src_y,
                            unsigned int src_w, unsigned int src_h, int dest_x,
                            int dest_y, unsigned int dest_w,
