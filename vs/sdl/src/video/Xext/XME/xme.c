...
#define XiGMiscGetReq(name, req, info)                                         \
  GetReq(name, req);                                                           \
  req->reqType = info->codes->major_opcode;                                    \
  req->xigmiscReqType = X_##name;

#define XiGMiscGetReqExtra(name, n, req, info)                                 \
...
int XiGMiscQueryResolutions(Display *dpy, int screen, int view, int *pactive,
...
void XiGMiscChangeResolution(Display *dpy, int screen, int view, int width,
