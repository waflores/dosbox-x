/* $XFree86: xc/include/extensions/xf86dga1.h,v 1.2 1999/04/17 07:05:41 dawes
 * Exp $ */
/*
...
Bool SDL_NAME(XF86DGAQueryVersion)(
    ...
    Display * /* dpy */, int * /* majorVersion */, int * /* minorVersion */
#endif
);
...
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int * /* base addr */,
...
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, char ** /* base addr */,
    int * /* width */, int * /* bank_size */, int * /* ram_size */
#endif
);
...
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int /* enable */
#endif
);
...
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int * /* width */, int * /* height */
#endif
);

Status SDL_NAME(XF86DGASetViewPort)(
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int x /* X */, int y /* Y */
#endif
);

Status SDL_NAME(XF86DGAGetVidPage)(
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int * /* vid page */
#endif
);
...
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, Colormap /*Colormap */
#endif
);
...
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int * /* flags */
#endif
);

Bool SDL_NAME(XF86DGAViewPortChanged)(
#if NeedFunctionPrototypes
    Display * /* dpy */, int /* screen */, int /* n */
#endif
);
