...
static SDL_Surface *Caca_SetVideoMode(_THIS, SDL_Surface *current, int width,
...
static int Caca_Available(void) { return 1; /* Always available ! */ }
...
VideoBootStrap CACA_bootstrap = {"caca", "Color ASCII Art Library",
...
SDL_Surface *Caca_SetVideoMode(_THIS, SDL_Surface *current, int width,
                               int height, int bpp, Uint32 flags) {
  if (Caca_buffer) {
    free(Caca_buffer);
    Caca_buffer = NULL;
  ...
  Caca_bitmap = caca_create_bitmap(16, width, height, current->pitch, 0xf800,
...
static int Caca_AllocHWSurface(_THIS, SDL_Surface *surface) { return (-1); }
static void Caca_FreeHWSurface(_THIS, SDL_Surface *surface) { return; }
...
static void Caca_UnlockHWSurface(_THIS, SDL_Surface *surface) { return; }
