...
#define Vread(current_mode) (void)trap_14_wl((short)0x41, (long)(current_mode))
#define Vwrite(init_vdi, inparam, outparam)                                    \
  (long)trap_14_wwll((short)0x42, (short)(init_vdi), (long)(inparam),          \
                     (long)(outparam))
...
#define Vdelete(handle) (long)trap_14_ww((short)0x45, (short)(handle))
...
#define Vvalid(handle) (long)trap_14_ww((short)0x48, (short)(handle))
#define Vload() (long)trap_14_w((short)0x49)
#define Vsave() (long)trap_14_w((short)0x4a)
#define Vopen() (long)trap_14_w((short)0x4b)
#define Vclose() (long)trap_14_w((short)0x4c)
#define Vscroll(scrollmode) (long)trap_14_ww((short)0x4d, (short)(scrollmode))
#define Voffset() (long)trap_14_w((short)0x4e)
#define Vseek() (long)trap_14_w((short)0x4f)
#define Vlock(cmd) (long)trap_14_ww((short)0x50, (short)(cmd))
#define SetMon(montype) (long)trap_14_ww((short)0x51, (short)(montype))
#define MultiMon(cmd) (long)trap_14_ww((short)0x52, (short)(cmd))
#define VSizeComp() (long)trap_14_w((short)0x53)
#define Vsize(mode) (long)trap_14_wl((short)0x54, (long)(mode))
