...
struct SDL_PrivateVideoData {
  ...
  uint32_t
      s_bounded_input_height; // height of input (bounded by writeable height)
  uint32_t s_bounded_input_width_offset;  // offset from the left side (used for
                                          // centering)
  uint32_t s_bounded_input_height_offset; // offset from the upper side (used
                                          // for centering)
...
#define s_bounded_input_width_offset                                           \
  (this->hidden->s_bounded_input_width_offset)
#define s_bounded_input_height_offset                                          \
  (this->hidden->s_bounded_input_height_offset)
