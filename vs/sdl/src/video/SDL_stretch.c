...
#if ((defined(_MFC_VER) &&                                                     \
      defined(_M_IX86) /* && !defined(_WIN32_WCE) still needed? */) ||         \
     defined(__WATCOMC__) || (defined(__GNUC__) && defined(__i386__))) &&      \
...
*/
int SDL_SoftStretch(SDL_Surface *src, SDL_Rect *srcrect, SDL_Surface *dst,
                    SDL_Rect *dstrect) {
  int src_locked;
  int dst_locked;
  int pos, inc;
