...
static struct {
  ...
  int format;
    ...
    {"8859-1", ENCODING_LATIN1},   {"ISO-8859-1", ENCODING_LATIN1},
    {"UTF8", ENCODING_UTF8},       {"UTF-8", ENCODING_UTF8},
    {"UTF16", ENCODING_UTF16},     {"UTF-16", ENCODING_UTF16},
    {"UTF16BE", ENCODING_UTF16BE}, {"UTF-16BE", ENCODING_UTF16BE},
    {"UTF16LE", ENCODING_UTF16LE}, {"UTF-16LE", ENCODING_UTF16LE},
    {"UTF32", ENCODING_UTF32},     {"UTF-32", ENCODING_UTF32},
    {"UTF32BE", ENCODING_UTF32BE}, {"UTF-32BE", ENCODING_UTF32BE},
    {"UTF32LE", ENCODING_UTF32LE}, {"UTF-32LE", ENCODING_UTF32LE},
    {"UCS2", ENCODING_UCS2},       {"UCS-2", ENCODING_UCS2},
    {"UCS4", ENCODING_UCS4},       {"UCS-4", ENCODING_UCS4},
};
...
size_t SDL_iconv(SDL_iconv_t cd, const char **inbuf, size_t *inbytesleft,
    ...
    /* Scan for a byte order marker */
    {
      ...
      while (n) {
        if (p[0] == 0xFF && p[1] == 0xFE && p[2] == 0x00 && p[3] == 0x00) {
          ...
          break;
        } else if (p[0] == 0x00 && p[1] == 0x00 && p[2] == 0xFE &&
                   p[3] == 0xFF) {
  ...
  while (srclen > 0) {
    ...
    case ENCODING_UTF32BE: {
      ...
      ch = ((Uint32)p[0] << 24) | ((Uint32)p[1] << 16) | ((Uint32)p[2] << 8) |
           (Uint32)p[3];
      src += 4;
      srclen -= 4;
    } break;
    case ENCODING_UTF32LE: {
      ...
      ch = ((Uint32)p[3] << 24) | ((Uint32)p[2] << 16) | ((Uint32)p[1] << 8) |
           (Uint32)p[0];
      src += 4;
      srclen -= 4;
    } break;
