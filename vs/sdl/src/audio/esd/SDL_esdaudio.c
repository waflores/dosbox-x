...
static void UnloadESDLibrary() { return; }
...
AudioBootStrap ESD_bootstrap = {ESD_DRIVER_NAME, "Enlightened Sound Daemon",
...
static Uint8 *ESD_GetAudioBuf(_THIS) { return (mixbuf); }
