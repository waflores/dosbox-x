...
// MMX assembler version of SDL_MixAudio for signed little endian 16 bit samples
// and signed 8 bit samples Copyright 2002 Stephane Marchesin
// (stephane.marchesin@wanadoo.fr) Converted to Intel ASM notation by Cth This
// code is licensed under the LGPL (see COPYING for details)
//
...
void SDL_MixAudio_MMX_S16_VC(char *dst, char *src, unsigned int nSize,
                             int volume) {
  __asm
  {
...
void SDL_MixAudio_MMX_S8_VC(char *dst, char *src, unsigned int nSize,
                            int volume) {
  _asm
  {
...
mixloopS8:
		...
		movq	mm3, mm1    //%%mm1,%%mm3 	// mm3 = a|b|c|d|e|f|g|h
            // on va faire le "sign extension" en faisant un cmp avec 0 qui
         // retourne 1 si <0, 0 si >0
		...
		packsswb mm3, mm1    //%%mm1,%%mm3	// mm1 =
         //v*a/128|v*b/128|v*c/128|v*d/128|v*e/128|v*f/128|v*g/128|v*h/128
