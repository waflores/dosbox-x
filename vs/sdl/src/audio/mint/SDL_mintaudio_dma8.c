...
AudioBootStrap MINTAUDIO_DMA8_bootstrap = {MINT_AUDIO_DRIVER_NAME,
                                           "MiNT DMA 8 bits audio driver",
                                           Audio_Available, Audio_CreateDevice};

static void Mint_LockAudio(_THIS) { Supexec(Mint_StopReplay); }

static void Mint_UnlockAudio(_THIS) { Supexec(Mint_StartReplay); }
