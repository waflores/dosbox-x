...
static const int freqs[16] = {4995,  6269,  7493,  8192,  9830,  10971,
                              12538, 14985, 16384, 19819, 21943, 24576,
...
AudioBootStrap MINTAUDIO_STFA_bootstrap = {MINT_AUDIO_DRIVER_NAME,
