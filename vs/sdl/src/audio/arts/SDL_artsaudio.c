...
static arts_stream_t (*SDL_NAME(arts_play_stream))(int rate, int bits,
                                                   int channels,
                                                   const char *name);
static int (*SDL_NAME(arts_stream_set))(arts_stream_t s, arts_parameter_t param,
                                        int value);
...
static void UnloadARTSLibrary() { return; }

static int LoadARTSLibrary(void) { return 0; }
...
AudioBootStrap ARTS_bootstrap = {ARTS_DRIVER_NAME,
                                 "Analog Realtime Synthesizer", Audio_Available,
                                 Audio_CreateDevice};
...
static Uint8 *ARTS_GetAudioBuf(_THIS) { return (mixbuf); }
