...
static int (*SDL_NAME(pa_mainloop_iterate))(pa_mainloop *m, int block,
                                            int *retval);
static void (*SDL_NAME(pa_mainloop_free))(pa_mainloop *m);

static pa_operation_state_t (*SDL_NAME(pa_operation_get_state))(
    pa_operation *o);
static void (*SDL_NAME(pa_operation_cancel))(pa_operation *o);
static void (*SDL_NAME(pa_operation_unref))(pa_operation *o);

static pa_context *(*SDL_NAME(pa_context_new))(pa_mainloop_api *m,
                                               const char *name);
static int (*SDL_NAME(pa_context_connect))(pa_context *c, const char *server,
...
static pa_stream *(*SDL_NAME(pa_stream_new))(pa_context *c, const char *name,
                                             const pa_sample_spec *ss,
                                             const pa_channel_map *map);
static int (*SDL_NAME(pa_stream_connect_playback))(
...
static int (*SDL_NAME(pa_stream_write))(pa_stream *s, const void *data,
...
static pa_operation *(*SDL_NAME(pa_context_set_name))(
    pa_context *c, const char *name, pa_context_success_cb_t cb,
    void *userdata);
...
static struct {
  ...
  void **func;
    ...
    {"pa_simple_new", (void **)&SDL_NAME(pa_simple_new)},
    {"pa_simple_free", (void **)&SDL_NAME(pa_simple_free)},
    {"pa_channel_map_init_auto", (void **)&SDL_NAME(pa_channel_map_init_auto)},
    {"pa_mainloop_new", (void **)&SDL_NAME(pa_mainloop_new)},
    {"pa_mainloop_get_api", (void **)&SDL_NAME(pa_mainloop_get_api)},
    {"pa_mainloop_iterate", (void **)&SDL_NAME(pa_mainloop_iterate)},
    {"pa_mainloop_free", (void **)&SDL_NAME(pa_mainloop_free)},
    {"pa_operation_get_state", (void **)&SDL_NAME(pa_operation_get_state)},
    {"pa_operation_cancel", (void **)&SDL_NAME(pa_operation_cancel)},
    {"pa_operation_unref", (void **)&SDL_NAME(pa_operation_unref)},
    {"pa_context_new", (void **)&SDL_NAME(pa_context_new)},
    {"pa_context_connect", (void **)&SDL_NAME(pa_context_connect)},
    {"pa_context_get_state", (void **)&SDL_NAME(pa_context_get_state)},
    {"pa_context_disconnect", (void **)&SDL_NAME(pa_context_disconnect)},
    {"pa_context_unref", (void **)&SDL_NAME(pa_context_unref)},
    {"pa_stream_new", (void **)&SDL_NAME(pa_stream_new)},
    {"pa_stream_connect_playback",
     (void **)&SDL_NAME(pa_stream_connect_playback)},
    {"pa_stream_get_state", (void **)&SDL_NAME(pa_stream_get_state)},
    {"pa_stream_writable_size", (void **)&SDL_NAME(pa_stream_writable_size)},
    {"pa_stream_write", (void **)&SDL_NAME(pa_stream_write)},
    {"pa_stream_drain", (void **)&SDL_NAME(pa_stream_drain)},
    {"pa_stream_disconnect", (void **)&SDL_NAME(pa_stream_disconnect)},
    {"pa_stream_unref", (void **)&SDL_NAME(pa_stream_unref)},
    {"pa_context_set_name", (void **)&SDL_NAME(pa_context_set_name)},
};
...
static void UnloadPulseLibrary() { return; }

static int LoadPulseLibrary(void) { return 0; }
...
AudioBootStrap PULSE_bootstrap = {PULSE_DRIVER_NAME, "PulseAudio",
...
static void PULSE_WaitAudio(_THIS) {
  ...
  SDL_mutexP(current_audio->mixer_lock); // SDL_LockAudio(); but such function
                                         // refuses to lock within audio thread
  ...
  SDL_mutexV(current_audio->mixer_lock); // SDL_UnlockAudio(); but such function
                                         // refuses to lock within audio thread
...
static void PULSE_PlayAudio(_THIS) {
  ...
  if (SDL_NAME(pa_stream_write)(stream, mixbuf, mixlen, NULL, 0LL,
                                PA_SEEK_RELATIVE) < 0)
    this->enabled = 0;
}

static Uint8 *PULSE_GetAudioBuf(_THIS) { return (mixbuf); }
...
static int PULSE_OpenAudio(_THIS, SDL_AudioSpec *spec) {
  ...
  SDL_NAME(pa_channel_map_init_auto)(&pacmap, spec->channels,
  ...
  if (!(context =
            SDL_NAME(pa_context_new)(mainloop_api, this->hidden->caption))) {
    PULSE_CloseAudio(this);
  ...
  stream = SDL_NAME(pa_stream_new)(
      context, "Simple DirectMedia Layer", /* stream description */
      &paspec,                             /* sample format spec */
      &pacmap                              /* channel map */
  );
  if (stream == NULL) {
  ...
  if (SDL_NAME(pa_stream_connect_playback)(stream, NULL, &paattr, flags, NULL,
                                           NULL) < 0) {
    PULSE_CloseAudio(this);
