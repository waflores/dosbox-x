...
AudioBootStrap MMEAUDIO_bootstrap = {"waveout", "Tru64 MME WaveOut",
...
static void CALLBACK MME_CALLBACK(HWAVEOUT hwo, UINT uMsg, DWORD dwInstance,
...
static int MME_OpenAudio(_THIS, SDL_AudioSpec *spec) {
  ...
  result =
      waveOutOpen(&(shm->sound), WAVE_MAPPER, &(shm->wFmt.wf), MME_CALLBACK,
