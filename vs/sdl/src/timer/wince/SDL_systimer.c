...
static Uint64 wce_ticks(void) { return ((Uint64)GetTickCount()); }
...
static Sint32 wce_rel_date(void) { return ((Sint32)(wce_date() - start_date)); }
...
static void CALLBACK HandleAlarm(UINT uID, UINT uMsg, DWORD dwUser, DWORD dw1,
                                 DWORD dw2) {
  SDL_ThreadedTimerCheck();
}
