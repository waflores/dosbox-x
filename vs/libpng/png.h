...
PNG_FIXED_EXPORT(
    253, png_uint_32, png_get_cLLI_fixed,
    (png_const_structrp png_ptr, png_const_inforp info_ptr,
...
PNG_FP_EXPORT(256, png_uint_32, png_get_mDCV,
              (png_const_structrp png_ptr, png_const_inforp info_ptr,
               /* The chromaticities of the mastering display.  As cHRM, but
                * independent of the encoding endpoints in cHRM, or cICP, or
                * iCCP.  These values will always be in the range 0 to 1.3107.
                */
               double *white_x, double *white_y, double *red_x, double *red_y,
...
PNG_FIXED_EXPORT(
    257, png_uint_32, png_get_mDCV_fixed,
    (png_const_structrp png_ptr, png_const_inforp info_ptr,
     png_fixed_point *int_white_x, png_fixed_point *int_white_y,
     png_fixed_point *int_red_x, png_fixed_point *int_red_y,
     png_fixed_point *int_green_x, png_fixed_point *int_green_y,
...
#ifdef PNG_mDCV_SUPPORTED
PNG_FP_EXPORT(
    258, void, png_set_mDCV,
    (png_const_structrp png_ptr, png_inforp info_ptr,
     /* The chromaticities of the mastering display.  As cHRM, but independent
      * of the encoding endpoints in cHRM, or cICP, or iCCP.
      */
...
#define PNG_POWERPC_VSX                                                        \
  10 /* HARDWARE: PowerPC VSX SIMD instructions                                \
      * supported */
#endif
