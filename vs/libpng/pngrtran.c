 ...
 */
static png_fixed_point translate_gamma_flags(png_fixed_point output_gamma,
                                             int is_screen) {
...
static int unsupported_gamma(png_structrp png_ptr, png_fixed_point gamma,
                             int warn) {
...
void PNGAPI png_set_quantize(png_structrp png_ptr, png_colorp palette,
  ...
  if (full_quantize == 0) {
    ...
    png_ptr->quantize_index =
        (png_bytep)png_malloc(png_ptr, (png_alloc_size_t)num_palette);
  ...
  if (full_quantize != 0) {
    ...
    png_ptr->palette_lookup =
        (png_bytep)png_calloc(png_ptr, (png_alloc_size_t)(num_entries));
    ...
    case PNG_COLOR_TYPE_GRAY: {
      if (row_info->bit_depth == 2) {
        ...
        for (i = 0; i < row_width; i += 4) {
          ...
          *sp = (png_byte)(((((int)gamma_table[a | (a >> 2) | (a >> 4) |
                                               (a >> 6)])) &
                            0xc0) |
                           ((((int)gamma_table[(b << 2) | b | (b >> 2) |
                                               (b >> 4)]) >>
                             2) &
                            0x30) |
                           ((((int)gamma_table[(c << 4) | (c << 2) | c |
                                               (c >> 2)]) >>
                             4) &
                            0x0c) |
                           ((((int)gamma_table[(d << 6) | (d << 4) | (d << 2) |
                                               d]) >>
                             6)));
          sp++;
        }
