...
int readpng2_check_sig(uch *sig, int num) { return !png_sig_cmp(sig, 0, num); }
...
int readpng2_init(mainprog_info *mainprog_ptr) {
  ...
  png_ptr =
      png_create_read_struct(png_get_libpng_ver(NULL), mainprog_ptr,
  ...
  png_set_progressive_read_fn(png_ptr, mainprog_ptr, readpng2_info_callback,
                              readpng2_row_callback, readpng2_end_callback);
