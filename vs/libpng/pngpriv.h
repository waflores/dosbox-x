...
#define png_fixed_ITU(png_ptr, fp, s)                                          \
  ((fp) <= 214748 && (fp) >= 0 ? ((png_uint_32)(10000 * (fp)))                 \
                               : (png_fixed_error(png_ptr, s), 0))
#endif
...
PNG_INTERNAL_FUNCTION(void, png_write_cICP,
                      (png_structrp png_ptr, png_byte colour_primaries,
...
PNG_INTERNAL_FUNCTION(void, png_write_cLLI_fixed,
                      (png_structrp png_ptr, png_uint_32 maxCLL,
                       png_uint_32 maxFALL),
                      PNG_EMPTY);
#endif
...
PNG_INTERNAL_FUNCTION(void, png_write_mDCV_fixed,
                      (png_structrp png_ptr, png_uint_16 red_x,
                       png_uint_16 red_y, png_uint_16 green_x,
                       png_uint_16 green_y, png_uint_16 blue_x,
                       png_uint_16 blue_y, png_uint_16 white_x,
                       png_uint_16 white_y, png_uint_32 maxDL,
                       png_uint_32 minDL),
                      PNG_EMPTY);
#endif
