...
void png_read_filter_row_up_mmi(png_row_infop row_info, png_bytep row,
  ...
  __asm__ volatile(
      ...
      "bgtz   %[istop],    1b                      \n\t"
      : [rp] "=&f"(rp), [pp] "=&f"(pp)
      : [row] "r"(row), [prev_row] "r"(prev_row), [istop] "r"(istop)
      : "memory");
}
...
void png_read_filter_row_sub3_mmi(png_row_infop row_info, png_bytep row,
  ...
  __asm__ volatile(
      ...
      "bgtz       %[istop],   1b                            \n\t"
      : [rp] "=&f"(rp), [pp] "=&f"(pp), [dest] "=&f"(dest), [tmp0] "=&r"(tmp0),
        [ftmp0] "=&f"(ftmp[0]), [ftmp1] "=&f"(ftmp[1]), [eight] "=&f"(eight),
...
void png_read_filter_row_avg3_mmi(png_row_infop row_info, png_bytep row,
  ...
  __asm__ volatile(
      ...
      : [rp] "=&f"(rp), [pp] "=&f"(pp), [rp1] "=&f"(rp1), [pp1] "=&f"(pp1),
        ...
        [ftmp2] "=&f"(ftmp[2]), [one] "=&f"(one), [dest] "=&f"(dest),
        [eight] "=&f"(eight), [sixteen] "=&f"(sixteen),
