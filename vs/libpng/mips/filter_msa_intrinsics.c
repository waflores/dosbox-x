...
#define LW(psrc)                                                               \
  ({                                                                           \
    ...
    uint32_t val_m;                                                            \
                                                                               \
    __asm__ volatile("lw  %[val_m],  %[psrc_lw_m]  \n\t"                       \
                                                                               \
                     : [val_m] "=r"(val_m)                                     \
...
#define SH(val, pdst)                                                          \
  {                                                                            \
    ...
    uint16_t val_m = (val);                                                    \
                                                                               \
    __asm__ volatile("sh  %[val_m],  %[pdst_sh_m]  \n\t"                       \
                                                                               \
...
#define SW(val, pdst)                                                          \
  {                                                                            \
    ...
    uint32_t val_m = (val);                                                    \
                                                                               \
    __asm__ volatile("sw  %[val_m],  %[pdst_sw_m]  \n\t"                       \
                                                                               \
...
#define SD(val, pdst)                                                          \
  {                                                                            \
    ...
    uint64_t val_m = (val);                                                    \
                                                                               \
    __asm__ volatile("sd  %[val_m],  %[pdst_sd_m]  \n\t"                       \
                                                                               \
...
#define LW(psrc)                                                               \
  ({                                                                           \
    ...
    uint32_t val_m;                                                            \
                                                                               \
    __asm__ volatile("ulw  %[val_m],  %[psrc_lw_m]  \n\t"                      \
                                                                               \
                     : [val_m] "=r"(val_m)                                     \
                     : [psrc_lw_m] "m"(*psrc_lw_m));                           \
                                                                               \
...
#define SH(val, pdst)                                                          \
  {                                                                            \
    ...
    uint16_t val_m = (val);                                                    \
                                                                               \
    __asm__ volatile("ush  %[val_m],  %[pdst_sh_m]  \n\t"                      \
                                                                               \
                     : [pdst_sh_m] "=m"(*pdst_sh_m)                            \
                     : [val_m] "r"(val_m));                                    \
  }
...
#define SW(val, pdst)                                                          \
  {                                                                            \
    ...
    uint32_t val_m = (val);                                                    \
                                                                               \
    __asm__ volatile("usw  %[val_m],  %[pdst_sw_m]  \n\t"                      \
                                                                               \
                     : [pdst_sw_m] "=m"(*pdst_sw_m)                            \
                     : [val_m] "r"(val_m));                                    \
  }
...
void png_read_filter_row_up_msa(png_row_infop row_info, png_bytep row,
  ...
  for (i = 0; i < (istop >> 6); i++) {
    ...
    ADD4(src0, src4, src1, src5, src2, src6, src3, src7, src0, src1, src2,
         src3);
...
void png_read_filter_row_paeth4_msa(png_row_infop row_info, png_bytep row,
                                    png_const_bytep prev_row) {
...
void png_read_filter_row_paeth3_msa(png_row_infop row_info, png_bytep row,
                                    png_const_bytep prev_row) {
  int32_t count, rp_end;
  png_bytep nxt;
  png_const_bytep prev_nxt;
