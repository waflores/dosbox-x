...
#define FT_ASSIGNP_INNER( p, exp )                          \
  ( ft_debug_file_ = __FILE__, ft_debug_lineno_ = __LINE__, \
    FT_ASSIGNP( p, exp ) )
...
#define FT_MEM_REALLOC( ptr, cursz, newsz )                                   \
  FT_ASSIGNP_INNER(                                                           \
      ptr, ft_mem_realloc( memory, 1, (FT_Long)( cursz ), (FT_Long)( newsz ), \
                           ( ptr ), &error ) )
...
#define FT_MEM_QREALLOC( ptr, cursz, newsz )                                   \
  FT_ASSIGNP_INNER(                                                            \
      ptr, ft_mem_qrealloc( memory, 1, (FT_Long)( cursz ), (FT_Long)( newsz ), \
                            ( ptr ), &error ) )
...
#define FT_MEM_REALLOC_MULT( ptr, oldcnt, newcnt, itmsz )                   \
  FT_ASSIGNP_INNER(                                                         \
      ptr, ft_mem_realloc( memory, (FT_Long)( itmsz ), (FT_Long)( oldcnt ), \
...
#define FT_MEM_QREALLOC_MULT( ptr, oldcnt, newcnt, itmsz )                   \
  FT_ASSIGNP_INNER(                                                          \
      ptr, ft_mem_qrealloc( memory, (FT_Long)( itmsz ), (FT_Long)( oldcnt ), \
                            (FT_Long)( newcnt ), ( ptr ), &error ) )
...
#define FT_MEM_RENEW_ARRAY( ptr, cursz, newsz )                            \
  FT_ASSIGNP_INNER(                                                        \
      ptr, ft_mem_realloc( memory, sizeof( *( ptr ) ), (FT_Long)( cursz ), \
...
#define FT_MEM_QRENEW_ARRAY( ptr, cursz, newsz )                            \
  FT_ASSIGNP_INNER(                                                         \
      ptr, ft_mem_qrealloc( memory, sizeof( *( ptr ) ), (FT_Long)( cursz ), \
                            (FT_Long)( newsz ), ( ptr ), &error ) )
