...
#define FT_PEEK_SHORT( p ) \
  FT_INT16( FT_BYTE_U16( p, 0, 8 ) | FT_BYTE_U16( p, 1, 0 ) )
...
#define FT_READ_SHORT( var ) \
  FT_READ_MACRO( FT_Stream_ReadUShort, FT_Int16, var )
#define FT_READ_USHORT( var ) \
  FT_READ_MACRO( FT_Stream_ReadUShort, FT_UInt16, var )
#define FT_READ_UOFF3( var ) \
  FT_READ_MACRO( FT_Stream_ReadUOffset, FT_UInt32, var )
#define FT_READ_LONG( var ) FT_READ_MACRO( FT_Stream_ReadULong, FT_Int32, var )
#define FT_READ_ULONG( var ) \
  FT_READ_MACRO( FT_Stream_ReadULong, FT_UInt32, var )
...
#define FT_READ_LONG_LE( var ) \
  FT_READ_MACRO( FT_Stream_ReadULongLE, FT_Int32, var )
...
#define FT_STREAM_READ( buffer, count ) \
  FT_SET_ERROR(                         \
      FT_Stream_Read( stream, (FT_Byte*)( buffer ), (FT_ULong)( count ) ) )
