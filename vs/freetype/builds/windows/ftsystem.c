             ...
             HANDLE                hTemplateFile )
{
  ...
  len = MultiByteToWideChar( CP_ACP, MB_ERR_INVALID_CHARS, lpFileName, -1, NULL,
                             0 );
  ...
  MultiByteToWideChar( CP_ACP, MB_ERR_INVALID_CHARS, lpFileName, -1,
                       lpFileNameW, len );
...
FT_LOCAL_DEF( BOOL )
GetFileSizeEx2( HANDLE hFile, PLARGE_INTEGER lpFileSize )
{
  lpFileSize->u.LowPart = GetFileSize( hFile, (DWORD*)&lpFileSize->u.HighPart );
...
FT_Stream_Open( FT_Stream stream, const char* filepathname )
{
  ...
  /* open the file */
  file = CreateFileA( (LPCSTR)filepathname, GENERIC_READ, FILE_SHARE_READ, NULL,
