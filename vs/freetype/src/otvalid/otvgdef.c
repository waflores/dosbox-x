...
static void
otv_O_x_Ox( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes          p = table;
  FT_Bytes          Coverage;
  FT_UInt           GlyphCount;
...
static void
otv_CaretValue_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
...
static void
otv_MarkGlyphSets_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
                   ...
                   FT_Validator ftvalid )
{
  ...
  case 0:
    ...
    need_MarkAttachClassDef =
        FT_BOOL( otv_GSUBGPOS_have_MarkAttachmentType_flag( gsub ) ||
