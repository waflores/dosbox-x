...
static void
otv_x_sxy( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
...
static void
otv_u_O_O_u_O_O( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes          p = table;
...
static void
otv_Anchor_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
...
static void
otv_MarkArray_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  MarkCount;
...
static void
otv_SinglePos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_PairPos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
  ...
  case 1: /* PairPosFormat1 */
  {
    ...
    for ( ; PairSetCount > 0; PairSetCount-- )
      otv_PairSet_validate( table + FT_NEXT_USHORT( p ), ValueFormat1,
                            ValueFormat2, otvalid );
  }
  break;
...
static void
otv_CursivePos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_MarkBasePos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_MarkLigPos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_MarkMarkPos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_ContextPos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_ChainContextPos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static void
otv_ExtensionPos_validate( FT_Bytes table, OTV_Validator otvalid )
{
  FT_Bytes p = table;
  FT_UInt  PosFormat;
...
static const OTV_Validate_Func otv_gpos_validate_funcs[9] = {
    otv_SinglePos_validate,   otv_PairPos_validate,
