...
/* read an integer */
static FT_Long
cff_parse_integer( FT_Byte* start, FT_Byte* limit )
{
  FT_Byte* p   = start;
  FT_Int   v   = *p++;
  FT_Long  val = 0;
...
static FT_Fixed
do_fixed( CFF_Parser parser, FT_Byte** d, FT_Long scaling )
{
  if ( **d == 30 )
...
/* read a floating point number, either integer or real */
static FT_Fixed
cff_parse_fixed( CFF_Parser parser, FT_Byte** d )
{
...
static FT_Fixed
cff_parse_fixed_scaled( CFF_Parser parser, FT_Byte** d, FT_Long scaling )
{
...
static FT_Fixed
cff_parse_fixed_dynamic( CFF_Parser parser, FT_Byte** d, FT_Long* scaling )
{
  FT_ASSERT( scaling );
