...
static FT_Error
t1_ps_get_font_info( FT_Face face, PS_FontInfoRec* afont_info )
{
...
static FT_Error
t1_ps_get_font_extra( FT_Face face, PS_FontExtraRec* afont_extra )
{
...
static FT_Error
t1_ps_get_font_private( FT_Face face, PS_PrivateRec* afont_private )
{
