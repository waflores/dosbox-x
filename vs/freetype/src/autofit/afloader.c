                                  ...
                                  AF_StyleMetrics style_metrics )
{
       ...
       ( stdVW > 0 && stdVW != globals->standard_vertical_width ) )
  {
    ...
    darken_by_font_units_x = af_loader_compute_darkening( loader, face, stdVW );
    darken_x = FT_MulFix( darken_by_font_units_x, size_metrics->x_scale );
       ...
       ( stdHW > 0 && stdHW != globals->standard_horizontal_width ) )
  {
    ...
    darken_by_font_units_y = af_loader_compute_darkening( loader, face, stdHW );
    darken_y = FT_MulFix( darken_by_font_units_y, size_metrics->y_scale );
                      ...
                      FT_Int32  load_flags )
{
  ...
  case FT_GLYPH_FORMAT_OUTLINE:
    ...
    loader->pp2.x =
        FT_MulFix( slot->metrics.horiAdvance, hints->x_scale ) + hints->x_delta;
                             ...
                             FT_Pos    standard_width )
{
  ...
  ppem =
      FT_MAX( af_intToFixed( 4 ), af_intToFixed( face->size->metrics.x_ppem ) );
