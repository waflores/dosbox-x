...
static void
cf2_font_setup( CF2_Font font, const CF2_Matrix* transform )
{
  ...
  if ( !font->isT1 )
  {
    ...
    if ( hasVariations )
    {
                                        ...
                                        lenNormalizedV, normalizedV ) )
      {
        ...
        cffload->load_private_dict( decoder->cff, subFont, lenNormalizedV,
                                    normalizedV );
        needExtraSetup = TRUE;
      }
#endif
  ...
  if ( ft_memcmp( transform, &font->currentTransform,
  ...
  if ( needExtraSetup )
  {
    ...
    if ( boldenX > 0 )
    {
      ...
      /* synthetic bold font.                                          */
      cf2_computeDarkening( emRatio, ppem, font->stdVW, &font->darkenX, boldenX,
                            FALSE, font->darkenParams );
    }
    else
    ...
    cf2_computeDarkening( emRatio, ppem, font->stdHW, &font->darkenY, boldenY,
                          font->stemDarkened, font->darkenParams );
                     ...
                     CF2_F16Dot16*     glyphWidth )
{
  ...
  while ( 1 )
  {
    ...
    cf2_interpT2CharString( font, charstring,
                            (CF2_OutlineCallbacks)&font->outline, &translation,
                            FALSE, 0, 0, &advWidth );
