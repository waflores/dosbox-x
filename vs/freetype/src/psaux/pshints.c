...
static CF2_Int
cf2_getWindingMomentum( CF2_Fixed x1, CF2_Fixed y1, CF2_Fixed x2, CF2_Fixed y2 )
{
...
static CF2_Fixed
cf2_hintmap_map( CF2_HintMap hintmap, CF2_Fixed csCoord )
{
    ...
    if ( isPair )
    {
      ...
      CF2_Fixed midpoint = cf2_hintmap_map(
          ...
          ADD_INT32(
              ...
              SUB_INT32( secondHintEdge->csCoord, firstHintEdge->csCoord ) /
                  2 ) );
      ...
      firstHintEdge->dsCoord =
          cf2_hintmap_map( hintmap->initialHintMap, firstHintEdge->csCoord );
  }
                   ...
                   FT_Bool      initialMap )
{
  ...
  if ( !initialMap && !cf2_hintmap_isValid( hintmap->initialHintMap ) )
  {
    ...
    cf2_hintmap_build( hintmap->initialHintMap, hStemHintArray, vStemHintArray,
                       &tempHintMask, hintOrigin, TRUE );
  }
...
#define CF2_CS_SCALE( x ) ( ( ( x ) + 0x10 ) >> 5 )
  ...
  intersection->x =
      ADD_INT32( u1->x, FT_MulFix( s, SUB_INT32( u2->x, u1->x ) ) );
  intersection->y =
      ADD_INT32( u1->y, FT_MulFix( s, SUB_INT32( u2->y, u1->y ) ) );
                            ...
                            FT_Bool       close )
{
  ...
  case CF2_PathOpLineTo:
    ...
    if ( close )
    {
      ...
      cf2_glyphpath_hintPoint( glyphpath, &glyphpath->firstHintMap, &params.pt1,
  ...
  case CF2_PathOpCubeTo:
    ...
    cf2_glyphpath_hintPoint( glyphpath, hintmap, &params.pt1,
                             glyphpath->prevElemP1.x, glyphpath->prevElemP1.y );
    cf2_glyphpath_hintPoint( glyphpath, hintmap, &params.pt2,
                             glyphpath->prevElemP2.x, glyphpath->prevElemP2.y );
    cf2_glyphpath_hintPoint( glyphpath, hintmap, &params.pt3,
                             glyphpath->prevElemP3.x, glyphpath->prevElemP3.y );
...
/* element                                                            */
static void
cf2_glyphpath_pushMove( CF2_GlyphPath glyphpath, FT_Vector start )
{
  CF2_CallbackParamsRec params;
  ...
  cf2_glyphpath_hintPoint( glyphpath, &glyphpath->hintMap, &params.pt1, start.x,
                           start.y );
