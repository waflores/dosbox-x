 ...
 */
static FT_Error
cf2_checkTransform( const CF2_Matrix* transform, CF2_Int unitsPerEm )
{
  CF2_Fixed maxScale;
...
static void
cf2_setGlyphWidth( CF2_Outline outline, CF2_Fixed width )
{
...
static void
cf2_outline_init( CF2_Outline outline, FT_Memory memory, FT_Error* error )
{
  FT_ZERO( outline );
