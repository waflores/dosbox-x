                   ...
                   FT_Int       achar )
{
  ...
  if ( !error )
  {
    ...
    decoder->seac = TRUE;
    error =
        cff_decoder_parse_charstrings( decoder, charstring, charstring_len, 0 );
    decoder->seac = FALSE;
 ...
 */
static FT_Int
cff_compute_bias( FT_Int in_charstring_type, FT_UInt num_subrs )
{
  FT_Int result;
                               ...
                               FT_Bool      in_dict )
{
  ...
  while ( ip < limit )
  {
    ...
    else
    {
      ...
      if ( req_args & CFF_COUNT_CHECK_WIDTH )
      {
        if ( num_args > 0 && decoder->read_width )
        {
          ...
          case cff_op_endchar:
            ...
            set_width_ok =
                in_dict ? 0 : ( ( num_args == 5 ) || ( num_args == 1 ) );
            break;
      ...
      case cff_op_cntrmask:
        FT_TRACE4(
            ( "%s", op == cff_op_hintmask ? " hintmask" : " cntrmask" ) );
      ...
      case cff_op_seac:
        ...
        error = cff_operator_seac( decoder, args[0], args[1], args[2],
                                   (FT_Int)( args[3] >> 16 ),
                                   (FT_Int)( args[4] >> 16 ) );
      ...
      case cff_op_endchar:
        ...
        if ( num_args >= 4 )
        {
          ...
          error = cff_operator_seac( decoder, 0L, args[-4], args[-3],
                                     (FT_Int)( args[-2] >> 16 ),
                                     (FT_Int)( args[-1] >> 16 ) );
        ...
        else
        {
          ...
          if ( hinter )
          {
            ...
            error = hinter->apply( hinter->hints, builder->current,
      ...
      case cff_op_load:
        ...
        /* in version 16-March-2000                               */
        {
          ...
          if ( reg_idx <= 2 && idx < CFF_MAX_TRANS_ELEMENTS &&
               count <= num_axes )
          {
            FT_UInt end, i;
