...
static void
ftc_node_mru_link( FTC_Node node, FTC_Manager manager )
{
...
static void
ftc_node_mru_unlink( FTC_Node node, FTC_Manager manager )
{
  void* nl = &manager->nodes_list;
...
static void
ftc_node_mru_up( FTC_Node node, FTC_Manager manager )
{
...
static void
ftc_node_hash_unlink( FTC_Node node0, FTC_Cache cache )
{
...
static void
ftc_node_hash_link( FTC_Node node, FTC_Cache cache )
{
...
static void
ftc_cache_add( FTC_Cache cache, FT_Offset hash, FTC_Node node )
{
  node->hash        = hash;
