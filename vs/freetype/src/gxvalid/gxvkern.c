...
#define GXV_KERN_FMT2_DATA( field )                                         \
  ( ( (GXV_kern_subtable_fmt2_DataRec*)( GXV_KERN_DATA( subtable_data ) ) ) \
        ->field )
                                        ...
                                        GXV_Validator      gxvalid )
{
  ...
  gxv_array_getlimits_ushort(
      p, p + ( 2 * nGlyphs ), &( GXV_KERN_FMT2_DATA( offset_min[spec] ) ),
      &( GXV_KERN_FMT2_DATA( offset_max[spec] ) ), gxvalid );
                            ...
                            GXV_Validator gxvalid )
{
  ...
  {
    if ( gxv_kern_coverage_classic_microsoft_validate( coverage, format,
                                                       gxvalid ) )
    {
