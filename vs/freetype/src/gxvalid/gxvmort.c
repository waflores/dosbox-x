...
static void
gxv_mort_feature_validate( GXV_mort_feature f, GXV_Validator gxvalid )
{
...
static void
gxv_mort_chain_validate( FT_Bytes table, FT_Bytes limit, GXV_Validator gxvalid )
{
  FT_Bytes p = table;
#ifdef GXV_LOAD_UNUSED_VARS
  ...
  gxv_mort_featurearray_validate( p, table + chainLength, nFeatureFlags,
                                  gxvalid );
