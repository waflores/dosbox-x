                                       ...
                                       GXV_Validator gxvalid )
{
  ...
  GXV_TRACE(
      ( "offset to ligActionTable=0x%08lx\n", optdata->ligActionTable ) );
  GXV_TRACE(
      ( "offset to componentTable=0x%08lx\n", optdata->componentTable ) );
                                                 ...
                                                 GXV_Validator gxvalid )
{
...

  {
    ...
    { /* negative offset */
      gid_limit =
          gxvalid->face->num_glyphs - (FT_Long)( offset & 0x0000FFFFUL );
      if ( gid_limit > 0 )
        return;
    ...
    GXV_Validator                  gxvalid )
{
  ...
  if ( 0 < ligActionIndex )
    gxv_morx_subtable_type2_ligActionIndex_validate( table, ligActionIndex,
                                                     gxvalid );
}
                                                ...
                                                GXV_Validator gxvalid )
{
  ...
  FT_Bytes limit =
      table + optdata->ligatureTable + optdata->ligatureTable_length;
