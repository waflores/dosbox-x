...
static void t42_parse_font_matrix( FT_Face face, void* loader_ );
static void t42_parse_encoding( FT_Face face, void* loader_ );

static void t42_parse_charstrings( FT_Face face, void* loader_ );

static void t42_parse_sfnts( FT_Face face, void* loader_ );
...
#define T1CODE T1_FIELD_LOCATION_FONT_INFO
    ...
    T1_FIELD_STRING( "version", version, 0 ) T1_FIELD_STRING(
        "Notice",
        notice,
        0 ) T1_FIELD_STRING( "FullName", full_name, 0 )
        T1_FIELD_STRING( "FamilyName", family_name, 0 ) T1_FIELD_STRING(
            "Weight",
            weight,
            0 ) T1_FIELD_NUM( "ItalicAngle", italic_angle, 0 )
...
#define T1CODE T1_FIELD_LOCATION_FONT_DICT
                    ...
                    T1_FIELD_KEY( "FontName", font_name, 0 ) T1_FIELD_NUM(
                        "PaintType",
                        paint_type,
                        0 ) T1_FIELD_NUM( "FontType", font_type, 0 )
...
static void
t42_parse_encoding( FT_Face face, void* loader_ )
{
  T42_Face   t42face = (T42_Face)face;
  T42_Loader loader  = (T42_Loader)loader_;
  T42_Parser parser  = &loader->parser;
...
static void
t42_parse_sfnts( FT_Face face, void* loader_ )
{
  T42_Face   t42face = (T42_Face)face;
  T42_Loader loader  = (T42_Loader)loader_;
  T42_Parser parser  = &loader->parser;
      ...
      case BEFORE_TABLE_DIR:
        ...
        else
        {
          ...
          for ( i = 0; i < num_tables; i++ )
          {
            ...
            if ( len > size || ttf_reserved > (FT_Long)( size - len ) )
            {
              FT_ERROR(
                  ( "t42_parse_sfnts:"
...
static FT_Error
t42_load_keyword( T42_Face face, T42_Loader loader, T1_Field field )
{
  FT_Error error;
  void*    dummy_object;
  void**   objects;
  ...
  if ( field->type == T1_FIELD_TYPE_INTEGER_ARRAY ||
    ...
    error =
        T1_Load_Field_Table( &loader->parser, field, objects, max_objects, 0 );
  else
