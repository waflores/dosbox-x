                    ...
                    FT_UInt    buffer_max )
{
  ...
  FT_STRCPYN( buffer, t42face->type1.glyph_names[glyph_index], buffer_max );
                    ...
                    const FT_String* glyph_name )
{
  ...
  for ( i = 0; i < t42face->type1.num_glyphs; i++ )
  {
    ...
    if ( glyph_name[0] == gname[0] && !ft_strcmp( glyph_name, gname ) )
      return (FT_UInt)ft_strtol( (const char*)t42face->type1.charstrings[i],
                                 NULL, 10 );
  }
...
FT_CALLBACK_DEF( FT_Error )
t42_ps_get_font_info( FT_Face face, PS_FontInfoRec* afont_info )
{
...
FT_CALLBACK_DEF( FT_Error )
t42_ps_get_font_extra( FT_Face face, PS_FontExtraRec* afont_extra )
{
