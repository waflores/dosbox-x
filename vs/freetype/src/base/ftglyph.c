...
FT_CALLBACK_DEF( FT_Error )
ft_svg_glyph_init( FT_Glyph svg_glyph, FT_GlyphSlot slot )
{
  FT_ULong        doc_length;
...
FT_CALLBACK_DEF( FT_Error )
ft_svg_glyph_copy( FT_Glyph svg_source, FT_Glyph svg_target )
{
...
FT_CALLBACK_DEF( FT_Error )
ft_svg_glyph_prepare( FT_Glyph svg_glyph, FT_GlyphSlot slot )
{
  FT_SvgGlyph glyph = (FT_SvgGlyph)svg_glyph;
