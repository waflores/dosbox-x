...
DECLARE_INTERFACE_(ID3DXAnimationSet, IUnknown) {
  ...
  // SRT
  STDMETHOD(GetSRT)(THIS_ DOUBLE PeriodicPosition, // Position mapped to period
                                                   // (use GetPeriodicPosition)
                    UINT Animation,                // Animation index
                    D3DXVECTOR3 * pScale,          // Returns the scale
                    D3DXQUATERNION *
                        pRotation, // Returns the rotation as a quaternion
...
DECLARE_INTERFACE_(ID3DXAnimationController, IUnknown) {
  ...
  STDMETHOD(GetAnimationSetByName)(THIS_ LPCSTR szName,
                                   LPD3DXANIMATIONSET * ppAnimationSet) PURE;

  // Global time
  STDMETHOD(AdvanceTime)(THIS_ DOUBLE TimeDelta,
                         LPD3DXANIMATIONCALLBACKHANDLER pCallbackHandler) PURE;
  ...
  STDMETHOD_(D3DXEVENTHANDLE, KeyTrackEnable)(THIS_ UINT Track, BOOL NewEnable,
                                              DOUBLE StartTime) PURE;
