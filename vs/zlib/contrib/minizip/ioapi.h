...
#define fseeko64 fseek
    ...
    defined(__HAIKU__) || defined(MINIZIP_FOPEN_NO_64)
#define fopen64 fopen
...
typedef voidpf(ZCALLBACK *open_file_func)(voidpf opaque, const char *filename,
                                          int mode);
...
typedef long(ZCALLBACK *seek64_file_func)(voidpf opaque, voidpf stream,
                                          ZPOS64_T offset, int origin);
typedef voidpf(ZCALLBACK *open64_file_func)(voidpf opaque, const void *filename,
                                            int mode);
