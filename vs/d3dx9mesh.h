...
DECLARE_INTERFACE_(ID3DXMesh, ID3DXBaseMesh) {
  ...
  STDMETHOD(SetAttributeTable)(THIS_ CONST D3DXATTRIBUTERANGE * pAttribTable,
                               DWORD cAttribTableSize) PURE;
};
...
DECLARE_INTERFACE_(ID3DXSPMesh, IUnknown) {
  ...
  STDMETHOD(CloneMeshFVF)(THIS_ DWORD Options, DWORD FVF,
                          ...
                          DWORD * pVertexRemapOut, LPD3DXMESH * ppCloneMesh)
      PURE;
...
DECLARE_INTERFACE_(ID3DXPatchMesh, IUnknown) {
  ...
  // adjacency
  STDMETHOD(CloneMesh)(THIS_ DWORD Options, CONST D3DVERTEXELEMENT9 * pDecl,
...
DECLARE_INTERFACE_(ID3DXSkinInfo, IUnknown) {
  ...
  STDMETHOD(SetBoneInfluence)(THIS_ DWORD bone, DWORD numInfluences,
      ...
      PURE;
  STDMETHOD(SetBoneVertexInfluence)(THIS_ DWORD boneNum, DWORD influenceNum,
                                    float weight) PURE;
  STDMETHOD_(DWORD, GetNumBoneInfluences)(THIS_ DWORD bone) PURE;
  STDMETHOD(GetBoneInfluence)(THIS_ DWORD bone, DWORD * vertices,
                              FLOAT * weights) PURE;
  STDMETHOD(GetBoneVertexInfluence)(THIS_ DWORD boneNum, DWORD influenceNum,
                                    float *pWeight, DWORD *pVertexNum) PURE;
  STDMETHOD(GetMaxVertexInfluences)(THIS_ DWORD * maxVertexInfluences) PURE;
  STDMETHOD_(DWORD, GetNumBones)(THIS) PURE;
  STDMETHOD(FindBoneVertexInfluenceIndex)(THIS_ DWORD boneNum, DWORD vertexNum,
  ...
  STDMETHOD(UpdateSkinnedMesh)(THIS_ CONST D3DXMATRIX * pBoneTransforms,
                               ...
                               LPCVOID pVerticesSrc, PVOID pVerticesDst) PURE;
...
DECLARE_INTERFACE_(ID3DXPRTBuffer, IUnknown) {
  ...
  STDMETHOD(LockBuffer)(THIS_ UINT Start, UINT NumSamples, FLOAT * *ppData)
      PURE;
...
DECLARE_INTERFACE_(ID3DXPRTEngine, IUnknown) {
  ...
  STDMETHOD(SetMeshMaterials)(THIS_ CONST D3DXSHMATERIAL * *ppMaterials,
                              UINT NumMeshes, UINT NumChannels, BOOL bSetAlbedo,
  ...
  STDMETHOD(SetPerVertexAlbedo)(THIS_ CONST VOID * pDataIn, UINT NumChannels,
                                UINT Stride) PURE;
  ...
  // NumChannels 1 implies "grayscale" materials, set this to 3 to enable
  //  color bleeding effects
  STDMETHOD(ExtractPerVertexAlbedo)(THIS_ LPD3DXMESH pMesh, D3DDECLUSAGE Usage,
  ...
  STDMETHOD(GetAdaptedMesh)(THIS_ LPDIRECT3DDEVICE9 pD3DDevice,
                            UINT * pFaceRemap, UINT * pVertRemap,
  ...
  STDMETHOD(SetSamplingInfo)(THIS_ UINT NumRays, BOOL UseSphere, BOOL UseCosine,
                             BOOL Adaptive, FLOAT AdaptiveThresh) PURE;
  ...
  STDMETHOD(ComputeSS)(THIS_ LPD3DXPRTBUFFER pDataIn, LPD3DXPRTBUFFER pDataOut,
  ...
  // per sample)
  STDMETHOD(ComputeLDPRTCoeffs)(THIS_ LPD3DXPRTBUFFER pDataIn, UINT SHOrder,
