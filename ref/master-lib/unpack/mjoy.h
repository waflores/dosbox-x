...
#define joyReadInfo(joy_data)                                                  \
  (js_sense(), (*(long *)(joy_data) = *(long *)js_stat), (joy_data[0].esc))
#define joyReadInfo2(joy_data)                                                 \
  (js_sense2(), (*(long *)(joy_data) = *(long *)js_stat), (joy_data[0].esc))
