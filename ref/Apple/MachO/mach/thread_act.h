...
extern
            ...
            thread_terminate(thread_act_t target_act);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    act_get_state(thread_read_t target_act, int flavor,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    act_set_state(thread_act_t target_act, int flavor, thread_state_t new_state,
...
extern
#endif /* mig_external */
    __WATCHOS_PROHIBITED kern_return_t
    thread_get_state(thread_read_t target_act, thread_state_flavor_t flavor,
                     thread_state_t old_state,
                     mach_msg_type_number_t *old_stateCnt);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED kern_return_t
    thread_set_state(thread_act_t target_act, thread_state_flavor_t flavor,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED kern_return_t
    thread_suspend(thread_read_t target_act);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED kern_return_t
    thread_resume(thread_read_t target_act);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED kern_return_t
    thread_abort(thread_act_t target_act);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED kern_return_t
    thread_abort_safely(thread_act_t target_act);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_depress_abort(thread_act_t thread);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_get_special_port(thread_inspect_t thr_act, int which_port,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_set_special_port(thread_act_t thr_act, int which_port,
                            mach_port_t special_port);
...
#endif /* mig_external */
    kern_return_t
    thread_info(thread_inspect_t target_act, thread_flavor_t flavor,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_set_exception_ports(thread_act_t thread,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_get_exception_ports(thread_act_t thread,
                               exception_mask_t exception_mask,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_swap_exception_ports(thread_act_t thread,
                                exception_mask_t exception_mask,
                                mach_port_t new_port,
                                exception_behavior_t behavior,
                                thread_state_flavor_t new_flavor,
...
#endif /* mig_external */
    kern_return_t
    thread_policy(thread_act_t thr_act, policy_t policy, policy_base_t base,
...
#endif /* mig_external */
    kern_return_t
    thread_policy_set(thread_act_t thread, thread_policy_flavor_t flavor,
...
#endif /* mig_external */
    kern_return_t
    thread_policy_get(thread_inspect_t thread, thread_policy_flavor_t flavor,
                      thread_policy_t policy_info,
                      mach_msg_type_number_t *policy_infoCnt,
...
#endif /* mig_external */
    kern_return_t
    thread_sample(thread_act_t thread, mach_port_t reply);
...
#endif /* mig_external */
    kern_return_t
    etap_trace_thread(thread_act_t target_act, boolean_t trace_status);
...
#endif /* mig_external */
    kern_return_t
    thread_assign(thread_act_t thread, processor_set_t new_set);
...
#endif /* mig_external */
    kern_return_t
    thread_assign_default(thread_act_t thread);
...
#endif /* mig_external */
    kern_return_t
    thread_get_assignment(thread_inspect_t thread,
...
#endif /* mig_external */
    kern_return_t
    thread_set_policy(thread_act_t thr_act, processor_set_t pset,
                      policy_t policy, policy_base_t base,
                      mach_msg_type_number_t baseCnt, policy_limit_t limit,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_get_mach_voucher(thread_read_t thr_act,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_set_mach_voucher(thread_act_t thr_act, ipc_voucher_t voucher);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    thread_swap_mach_voucher(thread_act_t thr_act, ipc_voucher_t new_voucher,
...
#endif /* mig_external */
    kern_return_t
    thread_convert_thread_state(thread_act_t thread, int direction,
...
union __RequestUnion__thread_act_subsystem {
  ...
  __Request__thread_get_exception_ports_info_t
      Request_thread_get_exception_ports_info;
};
...
#define subsystem_to_name_map_thread_act                                       \
  {"thread_terminate", 3600}, {"act_get_state", 3601},                         \
      {"act_set_state", 3602}, {"thread_get_state", 3603},                     \
      {"thread_set_state", 3604}, {"thread_suspend", 3605},                    \
      {"thread_resume", 3606}, {"thread_abort", 3607},                         \
      {"thread_abort_safely", 3608}, {"thread_depress_abort", 3609},           \
      {"thread_get_special_port", 3610}, {"thread_set_special_port", 3611},    \
      {"thread_info", 3612}, {"thread_set_exception_ports", 3613},             \
      {"thread_get_exception_ports", 3614},                                    \
      {"thread_swap_exception_ports", 3615}, {"thread_policy", 3616},          \
      {"thread_policy_set", 3617}, {"thread_policy_get", 3618},                \
      {"thread_sample", 3619}, {"etap_trace_thread", 3620},                    \
      {"thread_assign", 3621}, {"thread_assign_default", 3622},                \
      {"thread_get_assignment", 3623}, {"thread_set_policy", 3624},            \
      {"thread_get_mach_voucher", 3625}, {"thread_set_mach_voucher", 3626},    \
