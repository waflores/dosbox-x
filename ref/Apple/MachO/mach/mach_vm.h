...
#endif /* mig_external */
            kern_return_t
            mach_vm_allocate(vm_map_t target, mach_vm_address_t *address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_deallocate(vm_map_t target, mach_vm_address_t address,
                       mach_vm_size_t size);
...
#endif /* mig_external */
    kern_return_t
    mach_vm_protect(vm_map_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_inherit(vm_map_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_read(vm_map_read_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_read_list(vm_map_read_t target_task, mach_vm_read_entry_t data_list,
                      natural_t count);
...
#endif /* mig_external */
    kern_return_t
    mach_vm_write(vm_map_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_copy(vm_map_t target_task, mach_vm_address_t source_address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_read_overwrite(vm_map_read_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_msync(vm_map_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_behavior_set(vm_map_t target_task, mach_vm_address_t address,
                         mach_vm_size_t size, vm_behavior_t new_behavior);
...
#endif /* mig_external */
    kern_return_t
    mach_vm_machine_attribute(vm_map_t target_task, mach_vm_address_t address,
                              mach_vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_page_query(vm_map_read_t target_map, mach_vm_offset_t offset,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_region(vm_map_read_t target_task, mach_vm_address_t *address,
...
#endif /* mig_external */
    kern_return_t
    _mach_make_memory_entry(vm_map_t target_task, memory_object_size_t *size,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_purgable_control(vm_map_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_page_info(vm_map_read_t target_task, mach_vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_page_range_query(vm_map_read_t target_map, mach_vm_offset_t address,
                             mach_vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_remap_new(vm_map_t target_task, mach_vm_address_t *target_address,
                      mach_vm_size_t size, mach_vm_offset_t mask, int flags,
                      vm_map_read_t src_task, mach_vm_address_t src_address,
                      boolean_t copy, vm_prot_t *cur_protection,
                      vm_prot_t *max_protection, vm_inherit_t inheritance);
...
#define subsystem_to_name_map_mach_vm                                          \
  {"mach_vm_allocate", 4800}, {"mach_vm_deallocate", 4801},                    \
      {"mach_vm_protect", 4802}, {"mach_vm_inherit", 4803},                    \
      {"mach_vm_read", 4804}, {"mach_vm_read_list", 4805},                     \
      {"mach_vm_write", 4806}, {"mach_vm_copy", 4807},                         \
      {"mach_vm_read_overwrite", 4808}, {"mach_vm_msync", 4809},               \
      {"mach_vm_behavior_set", 4810}, {"mach_vm_map", 4811},                   \
      {"mach_vm_machine_attribute", 4812}, {"mach_vm_remap", 4813},            \
      {"mach_vm_page_query", 4814}, {"mach_vm_region_recurse", 4815},          \
      {"mach_vm_region", 4816}, {"_mach_make_memory_entry", 4817},             \
      {"mach_vm_purgable_control", 4818}, {"mach_vm_page_info", 4819},         \
      {"mach_vm_page_range_query", 4820}, {"mach_vm_remap_new", 4821}
#endif
