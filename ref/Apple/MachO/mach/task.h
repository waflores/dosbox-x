...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    task_suspend(task_read_t target_task);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    task_resume(task_read_t target_task);
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    task_get_special_port(task_inspect_t task, int which_port,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    task_set_special_port(task_t task, int which_port,
                          mach_port_t special_port);
...
#endif /* mig_external */
    kern_return_t
    lock_set_create(task_t task, lock_set_t *new_lock_set, int n_ulocks,
                    int policy);
...
#endif /* mig_external */
    kern_return_t
    semaphore_create(task_t task, semaphore_t *semaphore, int policy,
                     int value);
...
#endif /* mig_external */
    kern_return_t
    task_set_ras_pc(task_t target_task, vm_address_t basepc,
...
#endif /* mig_external */
    kern_return_t
    task_get_assignment(task_inspect_t task,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    task_suspend2(task_read_t target_task,
...
#endif /* mig_external */
    kern_return_t
    task_generate_corpse(task_read_t task, mach_port_t *corpse_task_port);
...
extern
    ...
    task_register_dyld_shared_cache_image_info(
        task_t task, dyld_kernel_image_info_t dyld_cache_image,
...
#endif /* mig_external */
    kern_return_t
    task_get_exc_guard_behavior(task_inspect_t task,
...
#endif /* mig_external */
    kern_return_t
    task_create_suid_cred(task_t task, suid_cred_path_t path,
                          suid_cred_uid_t uid, suid_cred_t *delegation);
...
#endif /* mig_external */
    kern_return_t
    task_create_identity_token(task_t task, task_id_token_t *token);
...
#endif /* mig_external */
    kern_return_t
    task_identity_token_get_task_port(task_id_token_t token,
...
union __RequestUnion__task_subsystem {
  ...
  __Request__task_register_dyld_shared_cache_image_info_t
      Request_task_register_dyld_shared_cache_image_info;
  ...
  __Request__task_register_dyld_get_process_state_t
      Request_task_register_dyld_get_process_state;
  ...
  __Request__task_dyld_process_info_notify_register_t
      Request_task_dyld_process_info_notify_register;
  ...
  __Request__task_dyld_process_info_notify_deregister_t
      Request_task_dyld_process_info_notify_deregister;
...
#define subsystem_to_name_map_task                                             \
  {"task_create", 3400}, {"task_terminate", 3401}, {"task_threads", 3402},     \
      {"mach_ports_register", 3403}, {"mach_ports_lookup", 3404},              \
      {"task_info", 3405}, {"task_set_info", 3406}, {"task_suspend", 3407},    \
      {"task_resume", 3408}, {"task_get_special_port", 3409},                  \
      {"task_set_special_port", 3410}, {"thread_create", 3411},                \
      {"thread_create_running", 3412}, {"task_set_exception_ports", 3413},     \
      {"task_get_exception_ports", 3414}, {"task_swap_exception_ports", 3415}, \
      {"lock_set_create", 3416}, {"lock_set_destroy", 3417},                   \
      {"semaphore_create", 3418}, {"semaphore_destroy", 3419},                 \
      {"task_policy_set", 3420}, {"task_policy_get", 3421},                    \
      {"task_sample", 3422}, {"task_policy", 3423},                            \
      {"task_set_emulation", 3424}, {"task_get_emulation_vector", 3425},       \
      {"task_set_emulation_vector", 3426}, {"task_set_ras_pc", 3427},          \
      {"task_zone_info", 3428}, {"task_assign", 3429},                         \
      {"task_assign_default", 3430}, {"task_get_assignment", 3431},            \
      {"task_set_policy", 3432}, {"task_get_state", 3433},                     \
      {"task_set_state", 3434}, {"task_set_phys_footprint_limit", 3435},       \
      {"task_suspend2", 3436}, {"task_resume2", 3437},                         \
      {"task_purgable_info", 3438}, {"task_get_mach_voucher", 3439},           \
      {"task_set_mach_voucher", 3440}, {"task_swap_mach_voucher", 3441},       \
      {"task_generate_corpse", 3442}, {"task_map_corpse_info", 3443},          \
      ...
      {"task_map_corpse_info_64", 3450}, {"task_inspect", 3451},               \
      {"task_get_exc_guard_behavior", 3452},                                   \
      {"task_set_exc_guard_behavior", 3453}, {"task_create_suid_cred", 3454},  \
