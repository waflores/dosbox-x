...
#endif /* mig_external */
    kern_return_t
    mach_memory_object_memory_entry(host_t host, boolean_t internal,
                                    vm_size_t size, vm_prot_t permission,
...
#endif /* mig_external */
    kern_return_t
    host_get_clock_service(host_t host, clock_id_t clock_id,
...
#endif /* mig_external */
    kern_return_t
    host_virtual_physical_table_info(host_t host,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    host_request_notification(host_t host, host_flavor_t notify_type,
...
extern
    ...
    host_register_mach_voucher_attr_manager(
        host_t host, mach_voucher_attr_manager_t attr_manager,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    host_get_atm_diagnostic_flag(host_t host, uint32_t *diagnostic_flag);
...
#endif /* mig_external */
    kern_return_t
    host_set_multiuser_config_flags(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    host_get_multiuser_config_flags(host_t host, uint32_t *multiuser_flags);
...
#endif /* mig_external */
    kern_return_t
    host_check_multiuser_mode(host_t host, uint32_t *multiuser_mode);
...
#endif /* mig_external */
    kern_return_t
    mach_zone_info_for_zone(host_priv_t host, mach_zone_name_t name,
...
union __RequestUnion__mach_host_subsystem {
  ...
  __Request__host_register_mach_voucher_attr_manager_t
      Request_host_register_mach_voucher_attr_manager;
  __Request__host_register_well_known_mach_voucher_attr_manager_t
      Request_host_register_well_known_mach_voucher_attr_manager;
  __Request__host_set_atm_diagnostic_flag_t
      Request_host_set_atm_diagnostic_flag;
  __Request__host_get_atm_diagnostic_flag_t
      Request_host_get_atm_diagnostic_flag;
  __Request__mach_memory_info_t Request_mach_memory_info;
  __Request__host_set_multiuser_config_flags_t
      Request_host_set_multiuser_config_flags;
  __Request__host_get_multiuser_config_flags_t
      Request_host_get_multiuser_config_flags;
...
union __ReplyUnion__mach_host_subsystem {
  ...
  __Reply__host_register_mach_voucher_attr_manager_t
      Reply_host_register_mach_voucher_attr_manager;
  __Reply__host_register_well_known_mach_voucher_attr_manager_t
...
#define subsystem_to_name_map_mach_host                                        \
  {"host_info", 200}, {"host_kernel_version", 201}, {"_host_page_size", 202},  \
      {"mach_memory_object_memory_entry", 203}, {"host_processor_info", 204},  \
      {"host_get_io_master", 205}, {"host_get_clock_service", 206},            \
      {"kmod_get_info", 207}, {"host_virtual_physical_table_info", 209},       \
      {"processor_set_default", 213}, {"processor_set_create", 214},           \
      {"mach_memory_object_memory_entry_64", 215}, {"host_statistics", 216},   \
      {"host_request_notification", 217}, {"host_lockgroup_info", 218},        \
      {"host_statistics64", 219}, {"mach_zone_info", 220},                     \
      ...
      {"host_get_atm_diagnostic_flag", 226}, {"mach_memory_info", 227},        \
      {"host_set_multiuser_config_flags", 228},                                \
      {"host_get_multiuser_config_flags", 229},                                \
      {"host_check_multiuser_mode", 230}, {"mach_zone_info_for_zone", 231}
#endif
