...
#endif /* mig_external */
    kern_return_t
    mach_voucher_extract_attr_recipe(ipc_voucher_t voucher,
...
#endif /* mig_external */
    kern_return_t
    mach_voucher_attr_command(ipc_voucher_t voucher,
                              mach_voucher_attr_key_t key,
...
#endif /* mig_external */
    kern_return_t
    mach_voucher_debug_info(ipc_space_read_t task,
...
union __RequestUnion__mach_voucher_subsystem {
  __Request__mach_voucher_extract_attr_content_t
      Request_mach_voucher_extract_attr_content;
...
union __ReplyUnion__mach_voucher_subsystem {
  __Reply__mach_voucher_extract_attr_content_t
      Reply_mach_voucher_extract_attr_content;
  __Reply__mach_voucher_extract_attr_recipe_t
      Reply_mach_voucher_extract_attr_recipe;
...
#define subsystem_to_name_map_mach_voucher                                     \
  {"mach_voucher_extract_attr_content", 5400},                                 \
      ...
      {"mach_voucher_attr_command", 5403}, {"mach_voucher_debug_info", 5404}
#endif
