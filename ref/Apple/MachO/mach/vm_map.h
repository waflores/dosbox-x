...
#endif /* mig_external */
            kern_return_t
            vm_region(vm_map_t target_task, vm_address_t *address,
...
#endif /* mig_external */
    kern_return_t
    vm_allocate(vm_map_t target_task, vm_address_t *address, vm_size_t size,
                int flags);
...
#endif /* mig_external */
    kern_return_t
    vm_protect(vm_map_t target_task, vm_address_t address, vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    vm_inherit(vm_map_t target_task, vm_address_t address, vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    vm_read(vm_map_t target_task, vm_address_t address, vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    vm_read_list(vm_map_t target_task, vm_read_entry_t data_list,
                 natural_t count);
...
#endif /* mig_external */
    kern_return_t
    vm_write(vm_map_t target_task, vm_address_t address, vm_offset_t data,
...
#endif /* mig_external */
    kern_return_t
    vm_copy(vm_map_t target_task, vm_address_t source_address, vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    vm_read_overwrite(vm_map_t target_task, vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    vm_behavior_set(vm_map_t target_task, vm_address_t address, vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    vm_map(vm_map_t target_task, vm_address_t *address, vm_size_t size,
...
#endif /* mig_external */
    kern_return_t
    vm_machine_attribute(vm_map_t target_task, vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    vm_remap(vm_map_t target_task, vm_address_t *target_address, vm_size_t size,
             vm_address_t mask, int flags, vm_map_t src_task,
             vm_address_t src_address, boolean_t copy,
...
#endif /* mig_external */
    kern_return_t
    vm_map_page_query(vm_map_t target_map, vm_offset_t offset,
...
#endif /* mig_external */
    kern_return_t
    mach_vm_region_info(vm_map_t task, vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    vm_mapped_pages_info(vm_map_t task, page_address_array_t *pages,
...
#endif /* mig_external */
    kern_return_t
    vm_region_recurse(vm_map_t target_task, vm_address_t *address,
                      vm_size_t *size, natural_t *nesting_depth,
...
#endif /* mig_external */
    kern_return_t
    vm_region_recurse_64(vm_map_t target_task, vm_address_t *address,
                         vm_size_t *size, natural_t *nesting_depth,
                         vm_region_recurse_info_t info,
                         mach_msg_type_number_t *infoCnt);
...
#endif /* mig_external */
    kern_return_t
    mach_vm_region_info_64(vm_map_t task, vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    vm_region_64(vm_map_t target_task, vm_address_t *address, vm_size_t *size,
...
#endif /* mig_external */
    kern_return_t
    vm_map_64(vm_map_t target_task, vm_address_t *address, vm_size_t size,
              vm_address_t mask, int flags, mem_entry_name_port_t object,
...
#endif /* mig_external */
    kern_return_t
    vm_purgable_control(vm_map_t target_task, vm_address_t address,
...
#endif /* mig_external */
    kern_return_t
    vm_map_exec_lockdown(vm_map_t target_task);
...
#endif /* mig_external */
    kern_return_t
    vm_remap_new(vm_map_t target_task, vm_address_t *target_address,
                 vm_size_t size, vm_address_t mask, int flags,
                 vm_map_read_t src_task, vm_address_t src_address,
...
#define subsystem_to_name_map_vm_map                                           \
  {"vm_region", 3800}, {"vm_allocate", 3801}, {"vm_deallocate", 3802},         \
      {"vm_protect", 3803}, {"vm_inherit", 3804}, {"vm_read", 3805},           \
      {"vm_read_list", 3806}, {"vm_write", 3807}, {"vm_copy", 3808},           \
      {"vm_read_overwrite", 3809}, {"vm_msync", 3810},                         \
      {"vm_behavior_set", 3811}, {"vm_map", 3812},                             \
      {"vm_machine_attribute", 3813}, {"vm_remap", 3814}, {"task_wire", 3815}, \
      {"mach_make_memory_entry", 3816}, {"vm_map_page_query", 3817},           \
      {"mach_vm_region_info", 3818}, {"vm_mapped_pages_info", 3819},           \
      {"vm_region_recurse", 3821}, {"vm_region_recurse_64", 3822},             \
      {"mach_vm_region_info_64", 3823}, {"vm_region_64", 3824},                \
      {"mach_make_memory_entry_64", 3825}, {"vm_map_64", 3826},                \
      {"vm_purgable_control", 3830}, {"vm_map_exec_lockdown", 3831},           \
      {"vm_remap_new", 3832}
#endif
