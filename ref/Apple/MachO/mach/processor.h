...
#endif /* mig_external */
    kern_return_t
    processor_info(processor_t processor, processor_flavor_t flavor,
                   host_t *host, processor_info_t processor_info_out,
...
#endif /* mig_external */
    kern_return_t
    processor_control(processor_t processor, processor_info_t processor_cmd,
...
#endif /* mig_external */
    kern_return_t
    processor_assign(processor_t processor, processor_set_t new_set,
                     boolean_t wait);
...
#define subsystem_to_name_map_processor                                        \
  {"processor_start", 3000}, {"processor_exit", 3001},                         \
      {"processor_info", 3002}, {"processor_control", 3003},                   \
      {"processor_assign", 3004}, {"processor_get_assignment", 3005}
#endif
