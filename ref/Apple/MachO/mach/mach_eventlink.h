...
#endif /* mig_external */
            kern_return_t
            mach_eventlink_create(task_t task,
...
#endif /* mig_external */
    kern_return_t
    mach_eventlink_destroy(mach_port_t eventlink);
...
#endif /* mig_external */
    kern_return_t
    mach_eventlink_associate(mach_port_t eventlink, thread_t thread,
...
#endif /* mig_external */
    kern_return_t
    mach_eventlink_disassociate(mach_port_t eventlink,
...
#define subsystem_to_name_map_mach_eventlink                                   \
  {"mach_eventlink_create", 716200}, {"mach_eventlink_destroy", 716201},       \
