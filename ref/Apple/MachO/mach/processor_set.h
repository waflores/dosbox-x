...
#endif /* mig_external */
            kern_return_t
            processor_set_statistics(processor_set_name_t pset,
...
#endif /* mig_external */
    kern_return_t
    processor_set_destroy(processor_set_t set);
...
#endif /* mig_external */
    kern_return_t
    processor_set_max_priority(processor_set_t processor_set, int max_priority,
...
#endif /* mig_external */
    kern_return_t
    processor_set_policy_enable(processor_set_t processor_set, int policy);
...
#endif /* mig_external */
    kern_return_t
    processor_set_policy_disable(processor_set_t processor_set, int policy,
                                 boolean_t change_threads);
...
#endif /* mig_external */
    kern_return_t
    processor_set_tasks(processor_set_t processor_set, task_array_t *task_list,
...
#endif /* mig_external */
    kern_return_t
    processor_set_threads(processor_set_t processor_set,
...
#endif /* mig_external */
    kern_return_t
    processor_set_policy_control(processor_set_t pset,
                                 processor_set_flavor_t flavor,
...
#endif /* mig_external */
    kern_return_t
    processor_set_stack_usage(processor_set_t pset, unsigned *ltotal,
                              vm_size_t *space, vm_size_t *resident,
...
#endif /* mig_external */
    kern_return_t
    processor_set_info(processor_set_name_t set_name, int flavor, host_t *host,
                       processor_set_info_t info_out,
                       mach_msg_type_number_t *info_outCnt);
...
#endif /* mig_external */
    kern_return_t
    processor_set_tasks_with_flavor(processor_set_t processor_set,
...
#define subsystem_to_name_map_processor_set                                    \
  {"processor_set_statistics", 4000}, {"processor_set_destroy", 4001},         \
      {"processor_set_max_priority", 4002},                                    \
      {"processor_set_policy_enable", 4003},                                   \
      {"processor_set_policy_disable", 4004}, {"processor_set_tasks", 4005},   \
      {"processor_set_threads", 4006}, {"processor_set_policy_control", 4007}, \
      {"processor_set_stack_usage", 4008}, {"processor_set_info", 4009},       \
