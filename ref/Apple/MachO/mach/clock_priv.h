...
#endif /* mig_external */
            kern_return_t
            clock_set_time(clock_ctrl_t clock_ctrl, mach_timespec_t new_time);
...
#endif /* mig_external */
    kern_return_t
    clock_set_attributes(clock_ctrl_t clock_ctrl, clock_flavor_t flavor,
...
#define subsystem_to_name_map_clock_priv                                       \
  {"clock_set_time", 1200}, {"clock_set_attributes", 1201}
#endif
