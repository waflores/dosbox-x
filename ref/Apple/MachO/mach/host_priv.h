...
#endif /* mig_external */
            kern_return_t
            host_get_boot_info(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    host_priv_statistics(host_priv_t host_priv, host_flavor_t flavor,
...
#endif /* mig_external */
    kern_return_t
    host_default_memory_manager(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    thread_wire(host_priv_t host_priv, thread_act_t thread, boolean_t wired);
...
#endif /* mig_external */
    kern_return_t
    vm_allocate_cpm(host_priv_t host_priv, vm_map_t task, vm_address_t *address,
...
#endif /* mig_external */
    kern_return_t
    host_processors(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    host_get_clock_control(host_priv_t host_priv, clock_id_t clock_id,
...
#endif /* mig_external */
    kern_return_t
    kmod_create(host_priv_t host_priv, vm_address_t info, kmod_t *module);
...
#endif /* mig_external */
    kern_return_t
    kmod_destroy(host_priv_t host_priv, kmod_t module);
...
#endif /* mig_external */
    kern_return_t
    kmod_control(host_priv_t host_priv, kmod_t module,
                 kmod_control_flavor_t flavor, kmod_args_t *data,
...
#endif /* mig_external */
    kern_return_t
    host_get_special_port(host_priv_t host_priv, int node, int which,
                          mach_port_t *port);
...
#endif /* mig_external */
    kern_return_t
    host_set_special_port(host_priv_t host_priv, int which, mach_port_t port);
...
#endif /* mig_external */
    kern_return_t
    host_set_exception_ports(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    host_get_exception_ports(host_priv_t host_priv,
                             exception_mask_t exception_mask,
...
#endif /* mig_external */
    kern_return_t
    host_swap_exception_ports(host_priv_t host_priv,
                              exception_mask_t exception_mask,
                              mach_port_t new_port,
                              exception_behavior_t behavior,
                              thread_state_flavor_t new_flavor,
...
#endif /* mig_external */
    kern_return_t
    host_processor_sets(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    host_processor_set_priv(host_priv_t host_priv,
...
#endif /* mig_external */
    kern_return_t
    host_set_UNDServer(host_priv_t host, UNDServerRef server);
...
#endif /* mig_external */
    kern_return_t
    host_get_UNDServer(host_priv_t host, UNDServerRef *server);
...
#endif /* mig_external */
    kern_return_t
    kext_request(host_priv_t host_priv, uint32_t user_log_flags,
                 ...
                 vm_offset_t *log_data, mach_msg_type_number_t *log_dataCnt,
...
#define subsystem_to_name_map_host_priv                                        \
  {"host_get_boot_info", 400}, {"host_reboot", 401},                           \
      {"host_priv_statistics", 402}, {"host_default_memory_manager", 403},     \
      {"vm_wire", 404}, {"thread_wire", 405}, {"vm_allocate_cpm", 406},        \
      {"host_processors", 407}, {"host_get_clock_control", 408},               \
      {"kmod_create", 409}, {"kmod_destroy", 410}, {"kmod_control", 411},      \
      {"host_get_special_port", 412}, {"host_set_special_port", 413},          \
      {"host_set_exception_ports", 414}, {"host_get_exception_ports", 415},    \
      {"host_swap_exception_ports", 416}, {"mach_vm_wire", 418},               \
      {"host_processor_sets", 419}, {"host_processor_set_priv", 420},          \
      {"host_set_UNDServer", 423}, {"host_get_UNDServer", 424},                \
      {"kext_request", 425}
#endif
