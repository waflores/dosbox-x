...
#define invalid_policy(policy)                                                 \
  ((policy) != POLICY_TIMESHARE && (policy) != POLICY_RR &&                    \
   (policy) != POLICY_FIFO)
...
#define POLICY_TIMESHARE_LIMIT_COUNT                                           \
  ((mach_msg_type_number_t)(sizeof(struct policy_timeshare_limit) /            \
                            sizeof(integer_t)))
#define POLICY_TIMESHARE_INFO_COUNT                                            \
  ((mach_msg_type_number_t)(sizeof(struct policy_timeshare_info) /             \
                            sizeof(integer_t)))
...
#define POLICY_RR_BASE_COUNT                                                   \
  ((mach_msg_type_number_t)(sizeof(struct policy_rr_base) / sizeof(integer_t)))
#define POLICY_RR_LIMIT_COUNT                                                  \
  ((mach_msg_type_number_t)(sizeof(struct policy_rr_limit) / sizeof(integer_t)))
#define POLICY_RR_INFO_COUNT                                                   \
  ((mach_msg_type_number_t)(sizeof(struct policy_rr_info) / sizeof(integer_t)))
...
#define POLICY_FIFO_BASE_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(struct policy_fifo_base) /                  \
                            sizeof(integer_t)))
#define POLICY_FIFO_LIMIT_COUNT                                                \
  ((mach_msg_type_number_t)(sizeof(struct policy_fifo_limit) /                 \
                            sizeof(integer_t)))
#define POLICY_FIFO_INFO_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(struct policy_fifo_info) /                  \
                            sizeof(integer_t)))
