...
#define VALID_THREAD_STATE_FLAVOR(x)                                           \
  ((x == ARM_THREAD_STATE) || (x == ARM_VFP_STATE) ||                          \
   ...
   (x == ARM_NEON_STATE) || (x == ARM_NEON_STATE64) ||                         \
   (x == ARM_DEBUG_STATE32) || (x == ARM_DEBUG_STATE64) ||                     \
   (x == ARM_PAGEIN_STATE) || (ARM_STATE_FLAVOR_IS_OTHER_VALID(x)))
...
#define ARM_AMX_STATE_V1_COUNT                                                 \
  ((mach_msg_type_number_t)(sizeof(arm_amx_state_v1_t) / sizeof(unsigned int)))

#define ARM_AMX_STATE_COUNT                                                    \
  ((mach_msg_type_number_t)(sizeof(arm_amx_state_t) / sizeof(unsigned int)))
