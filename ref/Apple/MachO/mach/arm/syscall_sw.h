...
#define _kernel_trap_0(trap_name, trap_number)                                 \
  _kernel_trap_0to4(trap_name, trap_number)
#define _kernel_trap_1(trap_name, trap_number)                                 \
  _kernel_trap_0to4(trap_name, trap_number)
#define _kernel_trap_2(trap_name, trap_number)                                 \
  _kernel_trap_0to4(trap_name, trap_number)
#define _kernel_trap_3(trap_name, trap_number)                                 \
  _kernel_trap_0to4(trap_name, trap_number)
#define _kernel_trap_4(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r5, r4 - r5)
#undef _kernel_trap_5
#define _kernel_trap_5(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r5, r4 - r5)
#define _kernel_trap_6(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r6 COMMA r8, r4 - r6 COMMA r8)
#define _kernel_trap_7(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r6 COMMA r8, r4 - r6 COMMA r8)
#define _kernel_trap_8(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r6 COMMA r8, r4 - r6 COMMA r8)
#define _kernel_trap_9(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r6 COMMA r8, r4 - r6 COMMA r8)
...
#define _kernel_trap_6(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r5, r4 - r5)
/* need to save r8 not just for alignment but because mach_msg_trap overwrites
 * the eighth argument */
#define _kernel_trap_7(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r6 COMMA r8, r4 - r6)
#define _kernel_trap_8(trap_name, trap_number)                                 \
  _kernel_trap_6to9(trap_name, trap_number, r4 - r6 COMMA r8, r4 - r6 COMMA r8)
/* there is only one nine-argument trap (mach_msg_overwrite_trap) and it doesn't
 * use the ninth argument */
#define _kernel_trap_9(trap_name, trap_number)                                 \
  _kernel_trap_8(trap_name, trap_number)
...
#define kernel_trap(trap_name, trap_number, num_args)                          \
  .globl _##trap_name % %.text % %.align 2 % % _##trap_name : % % mov x16,     \
      #(trap_number) % % svc #SWI_SYSCALL % % ret
