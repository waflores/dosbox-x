...
#endif /* mig_external */
            kern_return_t
            mach_port_names(ipc_space_t task, mach_port_name_array_t *names,
...
#endif /* mig_external */
    kern_return_t
    mach_port_type(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_rename(ipc_space_t task, mach_port_name_t old_name,
...
extern
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    mach_port_allocate_name(ipc_space_t task, mach_port_right_t right,
...
#endif /* mig_external */
    kern_return_t
    mach_port_allocate(ipc_space_t task, mach_port_right_t right,
                       mach_port_name_t *name);
...
#endif /* mig_external */
    kern_return_t
    mach_port_destroy(ipc_space_t task, mach_port_name_t name);
...
#endif /* mig_external */
    kern_return_t
    mach_port_deallocate(ipc_space_t task, mach_port_name_t name);
...
#endif /* mig_external */
    kern_return_t
    mach_port_get_refs(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_mod_refs(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_peek(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_set_mscount(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_get_set_status(ipc_space_read_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_move_member(ipc_space_t task, mach_port_name_t member,
...
#endif /* mig_external */
    kern_return_t
    mach_port_request_notification(ipc_space_t task, mach_port_name_t name,
                                   mach_msg_id_t msgid,
...
#endif /* mig_external */
    kern_return_t
    mach_port_insert_right(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_extract_right(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_set_seqno(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_get_attributes(ipc_space_read_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_set_attributes(ipc_space_t task, mach_port_name_t name,
                             mach_port_flavor_t flavor,
...
#endif /* mig_external */
    kern_return_t
    mach_port_allocate_qos(ipc_space_t task, mach_port_right_t right,
                           mach_port_qos_t *qos, mach_port_name_t *name);
...
#endif /* mig_external */
    kern_return_t
    mach_port_allocate_full(ipc_space_t task, mach_port_right_t right,
...
#endif /* mig_external */
    __WATCHOS_PROHIBITED __TVOS_PROHIBITED kern_return_t
    task_set_port_space(ipc_space_t task, int table_entries);
...
#endif /* mig_external */
    kern_return_t
    mach_port_get_srights(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_space_info(ipc_space_read_t space, ipc_info_space_t *space_info,
...
#endif /* mig_external */
    kern_return_t
    mach_port_dnrequest_info(ipc_space_t task, mach_port_name_t name,
                             unsigned *dnr_total, unsigned *dnr_used);
...
#endif /* mig_external */
    kern_return_t
    mach_port_kernel_object(ipc_space_read_t task, mach_port_name_t name,
                            unsigned *object_type, unsigned *object_addr);
...
#endif /* mig_external */
    kern_return_t
    mach_port_insert_member(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_extract_member(ipc_space_t task, mach_port_name_t name,
                             mach_port_name_t pset);
...
#endif /* mig_external */
    kern_return_t
    mach_port_get_context(ipc_space_read_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_set_context(ipc_space_t task, mach_port_name_t name,
                          mach_port_context_t context);
...
#endif /* mig_external */
    kern_return_t
    mach_port_kobject(ipc_space_read_t task, mach_port_name_t name,
                      natural_t *object_type, mach_vm_address_t *object_addr);
...
#endif /* mig_external */
    kern_return_t
    mach_port_construct(ipc_space_t task, mach_port_options_ptr_t options,
...
#endif /* mig_external */
    kern_return_t
    mach_port_destruct(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_guard(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_unguard(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_space_basic_info(ipc_space_inspect_t task,
...
#endif /* mig_external */
    kern_return_t
    mach_port_guard_with_flags(ipc_space_t task, mach_port_name_t name,
                               mach_port_context_t guard, uint64_t flags);
...
#endif /* mig_external */
    kern_return_t
    mach_port_swap_guard(ipc_space_t task, mach_port_name_t name,
...
#endif /* mig_external */
    kern_return_t
    mach_port_kobject_description(ipc_space_read_t task, mach_port_name_t name,
...
#define subsystem_to_name_map_mach_port                                        \
  {"mach_port_names", 3200}, {"mach_port_type", 3201},                         \
      {"mach_port_rename", 3202}, {"mach_port_allocate_name", 3203},           \
      {"mach_port_allocate", 3204}, {"mach_port_destroy", 3205},               \
      {"mach_port_deallocate", 3206}, {"mach_port_get_refs", 3207},            \
      {"mach_port_mod_refs", 3208}, {"mach_port_peek", 3209},                  \
      {"mach_port_set_mscount", 3210}, {"mach_port_get_set_status", 3211},     \
      {"mach_port_move_member", 3212},                                         \
      {"mach_port_request_notification", 3213},                                \
      {"mach_port_insert_right", 3214}, {"mach_port_extract_right", 3215},     \
      {"mach_port_set_seqno", 3216}, {"mach_port_get_attributes", 3217},       \
      {"mach_port_set_attributes", 3218}, {"mach_port_allocate_qos", 3219},    \
      {"mach_port_allocate_full", 3220}, {"task_set_port_space", 3221},        \
      {"mach_port_get_srights", 3222}, {"mach_port_space_info", 3223},         \
      {"mach_port_dnrequest_info", 3224}, {"mach_port_kernel_object", 3225},   \
      {"mach_port_insert_member", 3226}, {"mach_port_extract_member", 3227},   \
      {"mach_port_get_context", 3228}, {"mach_port_set_context", 3229},        \
      {"mach_port_kobject", 3230}, {"mach_port_construct", 3231},              \
      {"mach_port_destruct", 3232}, {"mach_port_guard", 3233},                 \
      {"mach_port_unguard", 3234}, {"mach_port_space_basic_info", 3235},       \
      {"mach_port_guard_with_flags", 3237}, {"mach_port_swap_guard", 3238},    \
