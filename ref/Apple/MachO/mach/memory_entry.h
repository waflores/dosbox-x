...
#endif /* mig_external */
            kern_return_t
            mach_memory_entry_purgable_control(mem_entry_name_port_t mem_entry,
...
#endif /* mig_external */
    kern_return_t
    mach_memory_entry_access_tracking(mem_entry_name_port_t mem_entry,
                                      int *access_tracking,
...
#endif /* mig_external */
    kern_return_t
    mach_memory_entry_ownership(mem_entry_name_port_t mem_entry, task_t owner,
...
union __RequestUnion__memory_entry_subsystem {
  __Request__mach_memory_entry_purgable_control_t
      Request_mach_memory_entry_purgable_control;
  __Request__mach_memory_entry_access_tracking_t
      Request_mach_memory_entry_access_tracking;
...
union __ReplyUnion__memory_entry_subsystem {
  __Reply__mach_memory_entry_purgable_control_t
      Reply_mach_memory_entry_purgable_control;
  __Reply__mach_memory_entry_access_tracking_t
      Reply_mach_memory_entry_access_tracking;
