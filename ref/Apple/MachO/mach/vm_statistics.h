...
#define VM_FLAGS_RETURN_DATA_ADDR                                              \
  0x100000 /* Return address of target data, rather than base of page */
#define VM_FLAGS_RETURN_4K_DATA_ADDR                                           \
  0x800000 /* Return 4K aligned address of target data */
...
enum virtual_memory_guard_exception_codes { kGUARD_EXC_DEALLOC_GAP = 1u << 0 };
