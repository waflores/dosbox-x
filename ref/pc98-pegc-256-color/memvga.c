...
REG8 MEMCALL memvgaf_rd8(UINT32 address) { return (vramex[address & 0x7ffff]); }
...
// ---- 8086 bank memory (PEGC memvga0:A8000h-AFFFFh, memvga1:B0000h-B7FFFh
// Bank(Packed-pixel Mode) or Plane Access(Plane Mode))
  ...
  if (address > 0xe0000 + 0x0100) {
    ...
    if (PEGC_REG_PATTERN <= pos) {
      ...
      if (vramop.mio2[PEGC_REG_PLANE_ROP] & 0x8000) {
        ...
        //      bit8     〜     bit0
        // pix0 <-- E0120h(8bit) -->     LOADINTELWORD
        // vramop.mio2[PEGC_REG_PATTERN + 0x1C], vramop.mio2[PEGC_REG_PATTERN +
        // 0x18], ... , vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit0) pix1 <--
        // E0124h(8bit) -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN +
        // 0x1C], vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit1) pix2 <-- E0128h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit2) pix3 <-- E012Ch(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit3) pix4 <-- E0130h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit4) pix5 <-- E0134h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit5) pix6 <-- E0138h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit6) pix7 <-- E013Ch(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit7) pix8 <-- E0140h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit8) pix9 <-- E0144h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit9) pix10<-- E0148h(8bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit10) pix11<-- E014Ch(8bit)
        // -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit11) pix12<-- E0150h(8bit)
        // -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit12) pix13<-- E0154h(8bit)
        // -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit13) pix14<-- E0158h(8bit)
        // -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit14) pix15<-- E015Ch(8bit)
        // -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
        // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit15)
        ...
        //      pix15     〜     pix0
        // bit0 <-- E0120h(16bit) -->     LOADINTELWORD
        // vramop.mio2[PEGC_REG_PATTERN + 0x00] bit1 <-- E0124h(16bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x04] bit2 <--
        // E0128h(16bit) -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN +
        // 0x08] bit3 <-- E012Ch(16bit) -->     LOADINTELWORD
        // vramop.mio2[PEGC_REG_PATTERN + 0x0C] bit4 <-- E0130h(16bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x10] bit5 <--
        // E0134h(16bit) -->     LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN +
        // 0x14] bit6 <-- E0138h(16bit) -->     LOADINTELWORD
        // vramop.mio2[PEGC_REG_PATTERN + 0x18] bit7 <-- E013Ch(16bit) -->
        // LOADINTELWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C]
...
void MEMCALL memvgaio_wr8(UINT32 address, REG8 value) {
  ...
  //	pegc.remain = 0;
  //	//pegc.lastdatalen = 0;
  //	pegc.lastdatalen = -(SINT32)((LOADINTELWORD(vramop.mio2+PEGC_REG_SHIFT))
  //& 0x1f);
  ////}
  address -= 0xe0000;
  pos = address - 0x0004;
    ...
    if (PEGC_REG_PATTERN <= pos) {
      ...
      if (vramop.mio2[PEGC_REG_PLANE_ROP] & 0x8000) {
        ...
        if ((pos & 0x3) == 0 && pos < 0x60) {
          ...
          for (i = 7; i >= 0; i--) {
            ret |=
                (LOADINTELWORD(vramop.mio2 + PEGC_REG_PATTERN + i * 4) >> bit) &
                0x1;
            ret <<= 1;
          }
        }
...
UINT32 MEMCALL memvgaio_rd32(UINT32 address) {
  ...
  if (address > 0xe0000 + 0x0100 && PEGC_REG_PATTERN <= pos) {
    ...
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane0   |<---   ofs = 03h           --->|<---   ofs = 02h --->|<--- ofs
    // = 01h           --->|<---   ofs = 00h           --->|
    //  (bit0)
    //  +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane1   |<---   ofs = 07h           --->|<---   ofs = 06h --->|<--- ofs
    // = 05h           --->|<---   ofs = 04h           --->|
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane2   |<---   ofs = 0Bh           --->|<---   ofs = 0Ah --->|<--- ofs
    // = 09h           --->|<---   ofs = 08h           --->|
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane3   |<---   ofs = 0Fh           --->|<---   ofs = 0Eh --->|<--- ofs
    // = 0Dh           --->|<---   ofs = 0Ch           --->|
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane4   |<---   ofs = 13h           --->|<---   ofs = 12h --->|<--- ofs
    // = 11h           --->|<---   ofs = 10h           --->|
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane5   |<---   ofs = 17h           --->|<---   ofs = 16h --->|<--- ofs
    // = 15h           --->|<---   ofs = 14h           --->|
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane6   |<---   ofs = 1Bh           --->|<---   ofs = 1Ah --->|<--- ofs
    // = 19h           --->|<---   ofs = 18h           --->|
    //          +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    // plane7   |<---   ofs = 1Fh           --->|<---   ofs = 1Eh --->|<--- ofs
    // = 1Dh           --->|<---   ofs = 1Ch           --->|
    //  (bit7)
    //  +---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+---+
    if (vramop.mio2[PEGC_REG_PLANE_ROP] & 0x8000) {
      ...
      //      bit8     〜     bit0
      // pix0 <-- E0120h(8bit) -->     LOADINTELDWORD
      // vramop.mio2[PEGC_REG_PATTERN + 0x1C], vramop.mio2[PEGC_REG_PATTERN +
      // 0x18], ... , vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit0) pix1 <--
      // E0124h(8bit) -->     LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN +
      // 0x1C], vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit1) pix2 <-- E0128h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit2) pix3 <-- E012Ch(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      ...
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit15) pix16<-- E0160h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit16) pix17<-- E0164h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit17) pix18<-- E0168h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit18) pix19<-- E016Ch(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit19) pix20<-- E0170h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit20) pix21<-- E0174h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit21) pix22<-- E0178h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit22) pix23<-- E017Ch(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit23) pix24<-- E0180h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit24) pix25<-- E0184h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit25) pix26<-- E0188h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit26) pix27<-- E018Ch(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit27) pix28<-- E0190h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit28) pix29<-- E0194h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit29) pix30<-- E0198h(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit30) pix31<-- E019Ch(8bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C],
      // vramop.mio2[PEGC_REG_PATTERN + 0x18], ... ,
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] (bit31)
      if ((pos & 0x3) == 0 && pos < 0x100) {
        int i;
        int bit = pos / 4;
        for (i = 7; i >= 0; i--) {
          ret |=
              (LOADINTELDWORD(vramop.mio2 + PEGC_REG_PATTERN + i * 4) >> bit) &
              0x1;
          ret <<= 1;
        }
      }
      ...
      //      pix31     〜     pix0
      // bit0 <-- E0120h(32bit) -->     LOADINTELDWORD
      // vramop.mio2[PEGC_REG_PATTERN + 0x00] bit1 <-- E0124h(32bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x04] bit2 <--
      // E0128h(32bit) -->     LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN +
      // 0x08] bit3 <-- E012Ch(32bit) -->     LOADINTELDWORD
      // vramop.mio2[PEGC_REG_PATTERN + 0x0C] bit4 <-- E0130h(32bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x10] bit5 <--
      // E0134h(32bit) -->     LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN +
      // 0x14] bit6 <-- E0138h(32bit) -->     LOADINTELDWORD
      // vramop.mio2[PEGC_REG_PATTERN + 0x18] bit7 <-- E013Ch(32bit) -->
      // LOADINTELDWORD vramop.mio2[PEGC_REG_PATTERN + 0x1C]
      if ((pos & 0x3) == 0 && pos < 0x40) {
