...
void assert_DTAExtendName(std::string input, std::string expected_name,
...
void assert_DOS_MakeName(char const *const input, bool exp_result,
...
TEST_F(DOS_FilesTest, DOS_MakeName_Uppercase) {
  ...
  assert_DOS_MakeName("autoexec.bat", true, "Windows\\Folder\\autoexec.bat",
                      25);
  uselfn = false;
  // lower case
  assert_DOS_MakeName("Z:\\autoexec.bat", true, "AUTOEXEC.BAT", 25);
...
TEST_F(DOS_FilesTest, DOS_MakeName_STRIP_SPACE) {
  ...
  assert_DOS_MakeName("Z:\\   A U T  OE X   EC     .BAT", true, "AUTOEXEC.BAT",
                      25);
  assert_DOS_MakeName("Z: \\   A U T  OE X   EC     .BAT", true, "AUTOEXEC.BAT",
                      25);
  assert_DOS_MakeName("12345   678.123", true, "12345678.123", 25);
  assert_DOS_MakeName("Z:\\\\A\\ B \\CDE\\ E F G\\", true, "A\\B\\CDE\\EFG",
                      25);
...
TEST_F(DOS_FilesTest, DOS_MakeName_DOS_PATHLENGTH_checks) {
  // Right on the line ...
  safe_strcpy(Drives[25]->curdir, "aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\"
                                  "aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaaa");
  assert_DOS_MakeName("BBBBB.BB", true,
                      "aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\a"
                      "aaaaaaaa\\aaaaaaaaaa\\BBBBB.BB",
                      25);
  assert_DOS_MakeName("BBBBBBB.BB", true,
                      "aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\aaaaaaaaa\\a"
                      "aaaaaaaa\\aaaaaaaaaa\\BBBBBBB.BB",
                      25);
}
...
TEST_F(DOS_FilesTest, DOS_MakeName_Dot_Handling) {
  ...
  assert_DOS_MakeName(".\\AUTOEXEC.BAT", true, "WINDOWS\\CONFIG\\AUTOEXEC.BAT",
                      25);
