...
static void FPU_FLD_32(PhysPt addr) { dyn_dh_fpu.temp.m1 = mem_readd(addr); }

static void FPU_FST_32(PhysPt addr) { mem_writed(addr, dyn_dh_fpu.temp.m1); }
...
static void FPU_FNINIT_DH(void) { dyn_dh_fpu.cw = 0x37f; }
...
static void dh_fpu_mem(uint8_t inst, Bitu reg = decode.modrm.reg,
                       void *mem = &dyn_dh_fpu.temp.m1) {
#if C_TARGETCPU == X86
  cache_addb(inst);
...
static void dh_fpu_esc1() {
  ...
  if (decode.modrm.val >= 0xc0) {
    ...
    case 0x03: /* FSTP float*/
      ...
      break;
    case 0x04: /* FLDENV */
      dyn_call_function_pagefault_check((void *)&FPU_FLDENV_DH, "%Drd%Ib",
                                        DREG(EA), !decode.big_op);
      dh_fpu_mem(0xd9);
      break;
    case 0x05: /* FLDCW */
      dyn_call_function_pagefault_check((void *)&FPU_FLDCW_DH, "%Drd",
                                        DREG(EA));
      dh_fpu_mem(0xd9);
      break;
    case 0x06: /* FSTENV */
      dh_fpu_mem(0xd9);
      dyn_call_function_pagefault_check((void *)&FPU_FSTENV_DH, "%Drd%Ib",
                                        DREG(EA), !decode.big_op);
      break;
    case 0x07: /* FNSTCW*/
      dyn_call_function_pagefault_check((void *)&FPU_FNSTCW_DH, "%Drd",
                                        DREG(EA));
      break;
    default:
      FPU_LOG_WARN(1, true, group, sub);
...
static void dh_fpu_esc5() {
  ...
  if (decode.modrm.val >= 0xc0) {
    ...
    case 0x03: /* FSTP double real*/
      ...
      break;
    case 0x04: /* FRSTOR */
      dyn_call_function_pagefault_check((void *)&FPU_FRSTOR_DH, "%Drd%Ib",
                                        DREG(EA), !decode.big_op);
      dh_fpu_mem(0xdd, decode.modrm.reg, &(dyn_dh_fpu.temp_state[0]));
      break;
    case 0x06: /* FSAVE */
      dh_fpu_mem(0xdd, decode.modrm.reg, &(dyn_dh_fpu.temp_state[0]));
      dyn_call_function_pagefault_check((void *)&FPU_FSAVE_DH, "%Drd%Ib",
                                        DREG(EA), !decode.big_op);
      cache_addw(0xE3DB);
      break;
    case 0x07: /* FNSTSW */
