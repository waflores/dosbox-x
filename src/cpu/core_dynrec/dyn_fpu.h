    ...
    case 0x04:
      ...
      case 0x03: /* ILLEGAL */
        LOG(LOG_FPU, LOG_WARN)("ESC 1:Unhandled group %X subfunction %X",
                               (unsigned int)decode.modrm.reg,
                               (unsigned int)decode.modrm.rm);
        break;
      case 0x04: /* FTST */
  ...
  if (decode.modrm.mod == 3) {
    ...
    case 0x05:
      ...
      case 0x01: /* FUCOMPP */
        gen_mov_word_to_reg(FC_OP2, (void *)(&FPUSW), true);
        gen_shr_imm(FC_OP2,
                    11); /* stack top is 3-bit value starting at bit 11 */
  ...
  if (decode.modrm.mod == 3) {
    ...
    case 0x04:
      ...
      case 0x05: // FRSTPM
        ...
        break;
      default:
        E_Exit("ESC 3:ILLEGAL OPCODE group %d subfunction %d",
               (unsigned int)decode.modrm.reg, (unsigned int)decode.modrm.rm);
      }
      break;
    default:
