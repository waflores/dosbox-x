...
static uint8_t DRC_CALL_CONV dynrec_add_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_adc_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_sub_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_sbb_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static void DRC_CALL_CONV dynrec_cmp_byte_simple(uint8_t op1,
                                                 uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_xor_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_and_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_or_byte_simple(uint8_t op1,
                                                   uint8_t op2) DRC_FC;
...
static void DRC_CALL_CONV dynrec_test_byte_simple(uint8_t op1,
                                                  uint8_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_add_word(uint16_t op1,
                                              uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_add_word_simple(uint16_t op1,
                                                     uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_add_word_simple(uint16_t op1,
                                                     uint16_t op2) {
  return op1 + op2;
...
static uint16_t DRC_CALL_CONV dynrec_adc_word(uint16_t op1,
                                              uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_adc_word_simple(uint16_t op1,
                                                     uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_adc_word_simple(uint16_t op1,
                                                     uint16_t op2) {
...
static uint16_t DRC_CALL_CONV dynrec_sub_word(uint16_t op1,
                                              uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_sub_word_simple(uint16_t op1,
                                                     uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_sub_word_simple(uint16_t op1,
                                                     uint16_t op2) {
  return op1 - op2;
...
static uint16_t DRC_CALL_CONV dynrec_sbb_word(uint16_t op1,
                                              uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_sbb_word_simple(uint16_t op1,
                                                     uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_sbb_word_simple(uint16_t op1,
                                                     uint16_t op2) {
  return (uint16_t)(op1 - (op2 + (Bitu)(get_CF() != 0)));
...
static void DRC_CALL_CONV dynrec_cmp_word_simple(uint16_t op1,
                                                 uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_xor_word(uint16_t op1,
                                              uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_xor_word_simple(uint16_t op1,
                                                     uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_xor_word_simple(uint16_t op1,
                                                     uint16_t op2) {
  return op1 ^ op2;
...
static uint16_t DRC_CALL_CONV dynrec_and_word(uint16_t op1,
                                              uint16_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_and_word_simple(uint16_t op1,
                                                     uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_and_word_simple(uint16_t op1,
                                                     uint16_t op2) {
  return op1 & op2;
...
static uint16_t DRC_CALL_CONV dynrec_or_word_simple(uint16_t op1,
                                                    uint16_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_or_word_simple(uint16_t op1,
                                                    uint16_t op2) {
  return op1 | op2;
...
static void DRC_CALL_CONV dynrec_test_word_simple(uint16_t op1,
                                                  uint16_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_add_dword(uint32_t op1,
                                               uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_add_dword_simple(uint32_t op1,
                                                      uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_add_dword_simple(uint32_t op1,
                                                      uint32_t op2) {
  return op1 + op2;
...
static uint32_t DRC_CALL_CONV dynrec_adc_dword(uint32_t op1,
                                               uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_adc_dword_simple(uint32_t op1,
                                                      uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_adc_dword_simple(uint32_t op1,
                                                      uint32_t op2) {
...
static uint32_t DRC_CALL_CONV dynrec_sub_dword(uint32_t op1,
                                               uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_sub_dword_simple(uint32_t op1,
                                                      uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_sub_dword_simple(uint32_t op1,
                                                      uint32_t op2) {
  return op1 - op2;
...
static uint32_t DRC_CALL_CONV dynrec_sbb_dword(uint32_t op1,
                                               uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_sbb_dword_simple(uint32_t op1,
                                                      uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_sbb_dword_simple(uint32_t op1,
                                                      uint32_t op2) {
  return op1 - (op2 + (Bitu)(get_CF() != 0));
...
static void DRC_CALL_CONV dynrec_cmp_dword_simple(uint32_t op1,
                                                  uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_xor_dword(uint32_t op1,
                                               uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_xor_dword_simple(uint32_t op1,
                                                      uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_xor_dword_simple(uint32_t op1,
                                                      uint32_t op2) {
  return op1 ^ op2;
...
static uint32_t DRC_CALL_CONV dynrec_and_dword(uint32_t op1,
                                               uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_and_dword_simple(uint32_t op1,
                                                      uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_and_dword_simple(uint32_t op1,
                                                      uint32_t op2) {
  return op1 & op2;
...
static uint32_t DRC_CALL_CONV dynrec_or_dword(uint32_t op1,
                                              uint32_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_or_dword_simple(uint32_t op1,
                                                     uint32_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_or_dword_simple(uint32_t op1,
                                                     uint32_t op2) {
  return op1 | op2;
...
static void DRC_CALL_CONV dynrec_test_dword_simple(uint32_t op1,
                                                   uint32_t op2) DRC_FC;
...
static void dyn_dop_byte_gencall(DualOps op) {
  ...
  case DOP_TEST:
    ...
    break;
  default:
    IllegalOptionDynrec("dyn_dop_byte_gencall");
  }
}
...
static void dyn_dop_word_gencall(DualOps op, bool dword) {
  if (dword) {
    ...
    case DOP_TEST:
      ...
      break;
    default:
      IllegalOptionDynrec("dyn_dop_dword_gencall");
    }
  } else {
    switch (op) {
    case DOP_ADD:
    ...
    case DOP_TEST:
      ...
      break;
    default:
      IllegalOptionDynrec("dyn_dop_word_gencall");
    }
  }
}
...
static uint8_t DRC_CALL_CONV dynrec_not_byte(uint8_t op) { return ~op; }
...
static uint16_t DRC_CALL_CONV dynrec_not_word(uint16_t op) { return ~op; }
...
static uint32_t DRC_CALL_CONV dynrec_not_dword(uint32_t op) { return ~op; }
...
static void dyn_sop_byte_gencall(SingleOps op) {
  ...
  case SOP_NEG:
    ...
    break;
  default:
    IllegalOptionDynrec("dyn_sop_byte_gencall");
  }
}
...
static void dyn_sop_word_gencall(SingleOps op, bool dword) {
  if (dword) {
    ...
    case SOP_NEG:
      ...
      break;
    default:
      IllegalOptionDynrec("dyn_sop_dword_gencall");
    }
  } else {
    switch (op) {
    case SOP_INC:
    ...
    case SOP_NEG:
      ...
      break;
    default:
      IllegalOptionDynrec("dyn_sop_word_gencall");
    }
  }
}
...
static uint8_t DRC_CALL_CONV dynrec_rol_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_ror_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_rcl_byte(uint8_t op1, uint8_t op2) {
  if (op2 % 9) {
    ...
    lf_var1b = op1;
    lf_var2b = op2 % 9;
    lf_resb = (lf_var1b << lf_var2b) | (cf << (lf_var2b - 1)) |
              (lf_var1b >> (9 - lf_var2b));
...
static uint8_t DRC_CALL_CONV dynrec_shl_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_shr_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint8_t DRC_CALL_CONV dynrec_sar_byte_simple(uint8_t op1,
                                                    uint8_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_rol_word_simple(uint16_t op1,
                                                     uint8_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_rol_word_simple(uint16_t op1,
                                                     uint8_t op2) {
  if (!(op2 & 0xf))
...
static uint16_t DRC_CALL_CONV dynrec_ror_word_simple(uint16_t op1,
                                                     uint8_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_ror_word_simple(uint16_t op1,
                                                     uint8_t op2) {
  if (!(op2 & 0xf))
...
static uint16_t DRC_CALL_CONV dynrec_shl_word_simple(uint16_t op1,
                                                     uint8_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_shl_word_simple(uint16_t op1,
                                                     uint8_t op2) {
  if (!op2)
...
static uint16_t DRC_CALL_CONV dynrec_shr_word_simple(uint16_t op1,
                                                     uint8_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_shr_word_simple(uint16_t op1,
                                                     uint8_t op2) {
  if (!op2)
...
static uint16_t DRC_CALL_CONV dynrec_sar_word_simple(uint16_t op1,
                                                     uint8_t op2) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_sar_word_simple(uint16_t op1,
                                                     uint8_t op2) {
  if (!op2)
  ...
  if (op2 > 16)
    op2 = 16;
  if (op1 & 0x8000)
    return (op1 >> op2) | (0xffff << (16 - op2));
  else
    return op1 >> op2;
}

static uint32_t DRC_CALL_CONV dynrec_rol_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_rol_dword_simple(uint32_t op1,
                                                      uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_rol_dword_simple(uint32_t op1,
                                                      uint8_t op2) {
  if (!op2)
...
static uint32_t DRC_CALL_CONV dynrec_ror_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_ror_dword_simple(uint32_t op1,
                                                      uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_ror_dword_simple(uint32_t op1,
                                                      uint8_t op2) {
  if (!op2)
...
static uint32_t DRC_CALL_CONV dynrec_rcl_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_rcl_dword(uint32_t op1, uint8_t op2) {
  ...
  if (lf_var2b == 1) {
    ...
    lf_resd = (lf_var1d << lf_var2b) | (cf << (lf_var2b - 1)) |
...
static uint32_t DRC_CALL_CONV dynrec_rcr_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_rcr_dword(uint32_t op1, uint8_t op2) {
  if (op2) {
    ...
    if (lf_var2b == 1) {
      ...
      lf_resd = (lf_var1d >> lf_var2b) | (cf << (32 - lf_var2b)) |
                (lf_var1d << (33 - lf_var2b));
    }
...
static uint32_t DRC_CALL_CONV dynrec_shl_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_shl_dword_simple(uint32_t op1,
                                                      uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_shl_dword_simple(uint32_t op1,
                                                      uint8_t op2) {
  if (!op2)
...
static uint32_t DRC_CALL_CONV dynrec_shr_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_shr_dword_simple(uint32_t op1,
                                                      uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_shr_dword_simple(uint32_t op1,
                                                      uint8_t op2) {
  if (!op2)
...
static uint32_t DRC_CALL_CONV dynrec_sar_dword(uint32_t op1,
                                               uint8_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_sar_dword_simple(uint32_t op1,
                                                      uint8_t op2) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_sar_dword_simple(uint32_t op1,
                                                      uint8_t op2) {
  if (!op2)
    return op1;
  if (op1 & 0x80000000)
    return (op1 >> op2) | (0xffffffff << (32 - op2));
  else
    return op1 >> op2;
}
...
static void dyn_shift_byte_gencall(ShiftOps op) {
  ...
  case SHIFT_SAR:
    ...
    break;
  default:
    IllegalOptionDynrec("dyn_shift_byte_gencall");
  }
}
...
static void dyn_shift_word_gencall(ShiftOps op, bool dword) {
  if (dword) {
    ...
    case SHIFT_SAR:
      ...
      break;
    default:
      IllegalOptionDynrec("dyn_shift_dword_gencall");
    }
  } else {
    switch (op) {
    case SHIFT_ROL:
    ...
    case SHIFT_SAR:
      ...
      break;
    default:
      IllegalOptionDynrec("dyn_shift_word_gencall");
    }
  }
}

static uint16_t DRC_CALL_CONV dynrec_dshl_word(uint16_t op1, uint16_t op2,
                                               uint8_t op3) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_dshl_word(uint16_t op1, uint16_t op2,
                                               uint8_t op3) {
...
static uint16_t DRC_CALL_CONV dynrec_dshl_word_simple(uint16_t op1,
                                                      uint16_t op2,
                                                      uint8_t op3) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_dshl_word_simple(uint16_t op1,
                                                      uint16_t op2,
...
static uint32_t DRC_CALL_CONV dynrec_dshl_dword(uint32_t op1, uint32_t op2,
                                                uint8_t op3) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_dshl_dword(uint32_t op1, uint32_t op2,
                                                uint8_t op3) {
  uint8_t val = op3 & 0x1f;
...
static uint32_t DRC_CALL_CONV dynrec_dshl_dword_simple(uint32_t op1,
                                                       uint32_t op2,
                                                       uint8_t op3) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_dshl_dword_simple(uint32_t op1,
                                                       uint32_t op2,
...
static uint16_t DRC_CALL_CONV dynrec_dshr_word(uint16_t op1, uint16_t op2,
                                               uint8_t op3) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_dshr_word(uint16_t op1, uint16_t op2,
                                               uint8_t op3) {
  uint8_t val = op3 & 0x1f;
...
static uint16_t DRC_CALL_CONV dynrec_dshr_word_simple(uint16_t op1,
                                                      uint16_t op2,
                                                      uint8_t op3) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_dshr_word_simple(uint16_t op1,
                                                      uint16_t op2,
...
static uint32_t DRC_CALL_CONV dynrec_dshr_dword(uint32_t op1, uint32_t op2,
                                                uint8_t op3) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_dshr_dword(uint32_t op1, uint32_t op2,
                                                uint8_t op3) {
  uint8_t val = op3 & 0x1f;
...
static uint32_t DRC_CALL_CONV dynrec_dshr_dword_simple(uint32_t op1,
                                                       uint32_t op2,
                                                       uint8_t op3) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_dshr_dword_simple(uint32_t op1,
                                                       uint32_t op2,
...
static uint32_t DRC_CALL_CONV dynrec_get_zf_or_sf_neq_of(void) {
  return TFLG_LE;
}
static uint32_t DRC_CALL_CONV dynrec_get_nzf_and_sf_eq_of(void) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_get_nzf_and_sf_eq_of(void) {
  return TFLG_NLE;
}
...
static void dyn_branchflag_to_reg(BranchTypes btype) {
  ...
  case BR_O:
    ...
    break;
  case BR_NO:
    gen_call_function_raw(dynrec_get_nof);
    break;
  case BR_B:
    gen_call_function_raw(dynrec_get_cf);
    break;
  case BR_NB:
    gen_call_function_raw(dynrec_get_ncf);
    break;
  case BR_Z:
    gen_call_function_raw(dynrec_get_zf);
    break;
  case BR_NZ:
    gen_call_function_raw(dynrec_get_nzf);
    break;
  case BR_BE:
    gen_call_function_raw(dynrec_get_cf_or_zf);
    break;
  case BR_NBE:
    gen_call_function_raw(dynrec_get_ncf_and_nzf);
    break;

  case BR_S:
    gen_call_function_raw(dynrec_get_sf);
    break;
  case BR_NS:
    gen_call_function_raw(dynrec_get_nsf);
    break;
  case BR_P:
    gen_call_function_raw(dynrec_get_pf);
    break;
  case BR_NP:
    gen_call_function_raw(dynrec_get_npf);
    break;
  case BR_L:
    gen_call_function_raw(dynrec_get_sf_neq_of);
    break;
  case BR_NL:
    gen_call_function_raw(dynrec_get_sf_eq_of);
    break;
  case BR_LE:
    gen_call_function_raw(dynrec_get_zf_or_sf_neq_of);
    break;
  case BR_NLE:
    gen_call_function_raw(dynrec_get_nzf_and_sf_eq_of);
    break;
  }
}
...
static bool DRC_CALL_CONV dynrec_div_byte(uint8_t op) {
  Bitu val = op;
  if (val == 0)
    return CPU_PrepareException(0, 0);
  Bitu quo = reg_ax / val;
...
static uint16_t DRC_CALL_CONV dynrec_dimul_word(uint16_t op1,
                                                uint16_t op2) DRC_FC;
...
static uint32_t DRC_CALL_CONV dynrec_dimul_dword(uint32_t op1,
                                                 uint32_t op2) DRC_FC;
...
static uint16_t DRC_CALL_CONV dynrec_cbw(uint8_t op) { return (int8_t)op; }

static uint32_t DRC_CALL_CONV dynrec_cwde(uint16_t op) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_cwde(uint16_t op) { return (int16_t)op; }
...
static uint16_t DRC_CALL_CONV dynrec_movsb_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base,
...
static uint32_t DRC_CALL_CONV dynrec_movsb_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt si_base,
                                                 PhysPt di_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_movsb_dword(uint32_t count,
...
static uint16_t DRC_CALL_CONV dynrec_movsw_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base,
                                                PhysPt di_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_movsw_word(uint16_t count,
...
static uint32_t DRC_CALL_CONV dynrec_movsw_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt si_base,
                                                 PhysPt di_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_movsw_dword(uint32_t count,
...
static uint16_t DRC_CALL_CONV dynrec_movsd_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base,
                                                PhysPt di_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_movsd_word(uint16_t count,
...
static uint32_t DRC_CALL_CONV dynrec_movsd_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt si_base,
                                                 PhysPt di_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_movsd_dword(uint32_t count,
...
static uint16_t DRC_CALL_CONV dynrec_lodsb_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_lodsb_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base) {
  uint16_t count_left;
...
static uint32_t DRC_CALL_CONV dynrec_lodsb_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt si_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_lodsb_dword(uint32_t count,
                                                 int32_t add_index,
...
static uint16_t DRC_CALL_CONV dynrec_lodsw_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_lodsw_word(uint16_t count,
                                                int16_t add_index,
...
static uint32_t DRC_CALL_CONV dynrec_lodsw_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt si_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_lodsw_dword(uint32_t count,
                                                 int32_t add_index,
...
static uint16_t DRC_CALL_CONV dynrec_lodsd_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt si_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_lodsd_word(uint16_t count,
                                                int16_t add_index,
...
static uint32_t DRC_CALL_CONV dynrec_lodsd_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt si_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_lodsd_dword(uint32_t count,
                                                 int32_t add_index,
...
static uint16_t DRC_CALL_CONV dynrec_stosb_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt di_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_stosb_word(uint16_t count,
                                                int16_t add_index,
...
static uint32_t DRC_CALL_CONV dynrec_stosb_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt di_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_stosb_dword(uint32_t count,
                                                 int32_t add_index,
...
static uint16_t DRC_CALL_CONV dynrec_stosw_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt di_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_stosw_word(uint16_t count,
                                                int16_t add_index,
...
static uint32_t DRC_CALL_CONV dynrec_stosw_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt di_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_stosw_dword(uint32_t count,
                                                 int32_t add_index,
...
static uint16_t DRC_CALL_CONV dynrec_stosd_word(uint16_t count,
                                                int16_t add_index,
                                                PhysPt di_base) DRC_FC;
static uint16_t DRC_CALL_CONV dynrec_stosd_word(uint16_t count,
                                                int16_t add_index,
...
static uint32_t DRC_CALL_CONV dynrec_stosd_dword(uint32_t count,
                                                 int32_t add_index,
                                                 PhysPt di_base) DRC_FC;
static uint32_t DRC_CALL_CONV dynrec_stosd_dword(uint32_t count,
                                                 int32_t add_index,
...
static bool DRC_CALL_CONV dynrec_io_readD(Bitu port) {
  bool ex = CPU_IO_Exception(port, 4);
  if (!ex)
    reg_eax = (uint32_t)IO_ReadD(port);
  return ex;
}
