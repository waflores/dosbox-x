...
enum { PFILEH_READONLY = 0x0001, PFILEH_MODIFY = 0x0002 };
...
BRESULT profile_read(const OEMCHAR *app, const OEMCHAR *key, const OEMCHAR *def,
...
void profile_iniread(const OEMCHAR *path, const OEMCHAR *app, const PFTBL *tbl,
                     UINT count, PFREAD cb);
void profile_iniwrite(const OEMCHAR *path, const OEMCHAR *app, const PFTBL *tbl,
                      UINT count, PFWRITE cb);
