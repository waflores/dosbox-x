...
void retrowave_mastergear_queue_ym2413(RetroWaveContext *ctx, uint8_t reg,
                                       uint8_t val) {
...
void retrowave_mastergear_queue_sn76489_left(RetroWaveContext *ctx,
                                             uint8_t val) {
  retrowave_cmd_buffer_init(ctx, RetroWave_Board_MasterGear, 0x12);
  ctx->transfer_speed_hint = transfer_speed;
...
void retrowave_mastergear_queue_sn76489_right(RetroWaveContext *ctx,
                                              uint8_t val) {
  retrowave_cmd_buffer_init(ctx, RetroWave_Board_MasterGear, 0x12);
  ctx->transfer_speed_hint = transfer_speed;
