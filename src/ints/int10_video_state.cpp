...
bool INT10_VideoState_Restore(Bitu state, RealPt buffer) {
  ...
  if (state & 1u) {
    ...
    for (ct = 1; ct < 5; ct++) {
      IO_WriteW(0x3c4,
                (uint16_t)((unsigned int)ct +
                           (unsigned int)(real_readb((unsigned int)base_seg,
                                                     (unsigned int)base_dest +
                                                         0x04 + ct)
                                          << 8u)));
    }
    ...
    for (ct = 0; ct < 4; ct++) {
      ...
      IO_WriteB(0x3c0,
                real_readb((unsigned int)base_seg,
                           (unsigned int)base_dest + 0x33 + (unsigned int)ct));
    }
    ...
    for (ct = 0; ct < 0x10; ct++) {
      ...
      IO_WriteB(0x3c0,
                real_readb((unsigned int)base_seg,
                           (unsigned int)base_dest + 0x23 + (unsigned int)ct));
    }

    IO_WriteB(0x3c4, real_readb((unsigned int)base_seg,
                                (unsigned int)base_dest + 0x00));
    IO_WriteB(0x3d4, real_readb((unsigned int)base_seg,
                                (unsigned int)base_dest + 0x01));
    IO_WriteB(0x3ce, real_readb((unsigned int)base_seg,
                                (unsigned int)base_dest + 0x02));
    IO_ReadB(crt_reg + 6u);
    IO_WriteB(0x3c0, real_readb((unsigned int)base_seg,
                                (unsigned int)base_dest + 0x03));
  }

  if (state & 2) {
    base_dest =
        real_readw((unsigned int)base_seg, (unsigned int)RealOff(buffer) + 2u);

    mem_writeb(0x410, (mem_readb(0x410) & 0xcf) |
                          real_readb((unsigned int)base_seg,
                                     (unsigned int)base_dest + 0x00));
    for (ct = 0; ct < 0x1e; ct++) {
      mem_writeb(0x449u + ct, real_readb((unsigned int)base_seg,
                                         (unsigned int)base_dest + 0x01u +
                                             (unsigned int)ct));
    }
    for (ct = 0; ct < 0x07; ct++) {
      mem_writeb(0x484u + ct, real_readb((unsigned int)base_seg,
                                         (unsigned int)base_dest + 0x1fu +
                                             (unsigned int)ct));
    }
  ...
  if (state & 4) {
    ...
    IO_WriteB(0x3c6, real_readb((unsigned int)base_seg,
                                (unsigned int)base_dest + 0x002));

    for (ct = 0; ct < 0x100; ct++) {
      IO_WriteB(0x3c8, (unsigned int)ct);
      IO_WriteB(0x3c9, real_readb((unsigned int)base_seg,
                                  (unsigned int)base_dest + 0x003 +
                                      (unsigned int)ct * 3u + 0u));
      IO_WriteB(0x3c9, real_readb((unsigned int)base_seg,
                                  (unsigned int)base_dest + 0x003 +
                                      (unsigned int)ct * 3u + 1u));
      IO_WriteB(0x3c9, real_readb((unsigned int)base_seg,
                                  (unsigned int)base_dest + 0x003 +
                                      (unsigned int)ct * 3u + 2u));
    }

    IO_ReadB(crt_reg + 6u);
    IO_WriteB(0x3c0, 0x14u);
    IO_WriteB(0x3c0, real_readb((unsigned int)base_seg,
                                (unsigned int)base_dest + 0x303));
    ...
    Bitu dac_state =
        real_readb((unsigned int)base_seg, (unsigned int)base_dest + 0x000);
    if (dac_state == 0) {
      IO_WriteB(0x3c8, real_readb((unsigned int)base_seg,
                                  (unsigned int)base_dest + 0x001));
    } else {
      IO_WriteB(0x3c7, real_readb((unsigned int)base_seg,
                                  (unsigned int)base_dest + 0x001));
    }
  }
  ...
  if ((svgaCard == SVGA_S3Trio) && (state & 8)) {
    base_dest =
        real_readw((unsigned int)base_seg, (unsigned int)RealOff(buffer) + 6u);
    ...
    for (ct = 0; ct < 0x40; ct++) {
      if ((ct == 0x4a - 0x30) || (ct == 0x4b - 0x30)) {
        ...
        IO_WriteB(crt_reg,
                  (unsigned int)real_readb((unsigned int)base_seg,
                                           (unsigned int)base_dest +
                                               (unsigned int)(ct_dest++)));
      } else {
        IO_WriteW(crt_reg,
                  (0x30 + (unsigned int)ct) +
                      (unsigned int)(real_readb((unsigned int)base_seg,
                                                (unsigned int)base_dest +
                                                    (unsigned int)(ct_dest++))
                                     << 8u));
