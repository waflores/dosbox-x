...
const uint8_t vparams[] = {
    ...
    0x38, 0x28, 0x2d, 0x0a, 0x1f, 0x06, 0x19, 0x1c, 0x02, 0x07, 0x06, 0x07, 0,
    0, 0, 0,
    // 80x25 mode 2 and 3 crtc registers
    0x71, 0x50, 0x5a, 0x0a, 0x1f, 0x06, 0x19, 0x1c, 0x02, 0x07, 0x06, 0x07, 0,
    0, 0, 0,
    // graphics modes 4, 5 and 6
    0x38, 0x28, 0x2d, 0x0a, 0x7f, 0x06, 0x64, 0x70, 0x02, 0x01, 0x06, 0x07, 0,
    0, 0, 0,
    // mode 7 MDA text
    0x61, 0x50, 0x52, 0x0f, 0x19, 0x06, 0x19, 0x19, 0x02, 0x0d, 0x0b, 0x0c, 0,
    0, 0, 0,
...
const uint8_t vparams_pcjr[] = {
    // 40x25 mode 0 and 1 crtc registers
    0x38, 0x28, 0x2c, 0x06, 0x1f, 0x06, 0x19, 0x1c, 0x02, 0x07, 0x06, 0x07, 0,
    0, 0, 0,
    // 80x25 mode 2 and 3 crtc registers
    0x71, 0x50, 0x5a, 0x0c, 0x1f, 0x06, 0x19, 0x1c, 0x02, 0x07, 0x06, 0x07, 0,
    0, 0, 0,
    // graphics modes 4, 5, 6, 8
    0x38, 0x28, 0x2b, 0x06, 0x7f, 0x06, 0x64, 0x70, 0x02, 0x01, 0x26, 0x07, 0,
    0, 0, 0,
    // other graphics modes
    0x71, 0x50, 0x56, 0x0c, 0x3f, 0x06, 0x32, 0x38, 0x02, 0x03, 0x26, 0x07, 0,
    0, 0, 0,
    // buffer length words 2048, 4096, 16384, 16384
    0x00, 0x08, 0x00, 0x10, 0x00, 0x40, 0x00, 0x40,
    // columns
...
const uint8_t vparams_tandy[] = {
    // 40x25 mode 0 and 1 crtc registers
    0x38, 0x28, 0x2c, 0x08, 0x1f, 0x06, 0x19, 0x1c, 0x02, 0x07, 0x06, 0x07, 0,
    0, 0, 0,
    // 80x25 mode 2 and 3 crtc registers
    0x71, 0x50, 0x58, 0x10, 0x1f, 0x06, 0x19, 0x1c, 0x02, 0x07, 0x06, 0x07, 0,
    0, 0, 0,
    // graphics modes 4, 5 and 6
    0x38, 0x28, 0x2c, 0x08, 0x7f, 0x06, 0x64, 0x70, 0x02, 0x01, 0x06, 0x07, 0,
    0, 0, 0,
    // graphics mode 7
    0x71, 0x50, 0x58, 0x10, 0x3f, 0x06, 0x32, 0x38, 0x02, 0x03, 0x06, 0x07, 0,
    0, 0, 0,
    // buffer length words 2048, 4096, 16384, 16384
    0x00, 0x08, 0x00, 0x10, 0x00, 0x40, 0x00, 0x40,
    // columns
...
/* Values copied from VP table snapshot on an IBM PS/2 model 30
 * [http://hackipedia.org/raw/Computer/Platform/PC%2c%20IBM%20compatible/Video/VGA/VGA%20register%20snapshots/IBM%20PS%2d2%20MODEL%2030%20286%20with%20VGA%20%282019%2d09%2d28%29%2etar%2exz]
 */
static uint8_t video_parameter_table_vga[0x40 * 0x1d] = {
    ...
    0x0f,
    0xff,
    // video parameter table for mode f (EGA 640x350 monochrone graphics, 64k
    // graphics memory)
    0x50,
    0x18,
    0x0e,
    ...
    0x0f,
    0xff,
    // video parameter table for mode 10 (EGA 640x350 4-color planar graphics,
    // 64k graphics memory)
    0x50,
    0x18,
    0x0e,
    ...
    0x0f,
    0xff,
    // video parameter table for mode f (EGA 640x350 monochrome graphics, >64k
    // graphics memory)
    0x50,
    0x18,
    0x0e,
    ...
    0x05,
    0xff,
    // video parameter table for mode 10 (EGA 640x350 16-color planar graphics,
    // >64k graphics memory)
    0x50,
    0x18,
    0x0e,
...
static uint8_t video_parameter_table_ega[0x40 * 0x17] = {
    // video parameter table for mode 0 (40x25 text CGA emulation grayscale)
    0x28, 0x18, 0x08, 0x00, 0x08, 0x0b, 0x03, 0x00, 0x03, 0x23, 0x37, 0x27,
    0x2d, 0x37, 0x31, 0x15, 0x04, 0x11, 0x00, 0x07, 0x06, 0x07, 0x00, 0x00,
    0x00, 0x00, 0xe1, 0x24, 0xc7, 0x14, 0x08, 0xe0, 0xf0, 0xa3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x08, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x0e, 0x00, 0xff,
    // video parameter table for mode 1 (40x25 text CGA emulation)
    0x28, 0x18, 0x08, 0x00, 0x08, 0x0b, 0x03, 0x00, 0x03, 0x23, 0x37, 0x27,
    0x2d, 0x37, 0x31, 0x15, 0x04, 0x11, 0x00, 0x07, 0x06, 0x07, 0x00, 0x00,
    ...
    0x10, 0x0e, 0x00, 0xff,
    // video parameter table for mode 2 (80x25 text CGA emulation grayscale)
    0x50, 0x18, 0x08, 0x00, 0x10, 0x01, 0x03, 0x00, 0x03, 0x23, 0x70, 0x4f,
    0x5c, 0x2f, 0x5f, 0x07, 0x04, 0x11, 0x00, 0x07, 0x06, 0x07, 0x00, 0x00,
    0x00, 0x00, 0xe1, 0x24, 0xc7, 0x28, 0x08, 0xe0, 0xf0, 0xa3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x08, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x0e, 0x00, 0xff,
    // video parameter table for mode 3 (80x25 text CGA emulation)
    ...
    0x10, 0x0e, 0x00, 0xff,
    // video parameter table for mode 4 (CGA 320x200 4-color grayscale)
    0x28, 0x18, 0x08, 0x00, 0x40, 0x0b, 0x03, 0x00, 0x02, 0x23, 0x37, 0x27,
    0x2d, 0x37, 0x30, 0x14, 0x04, 0x11, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xe1, 0x24, 0xc7, 0x14, 0x00, 0xe0, 0xf0, 0xa2, 0xff, 0x00,
    0x13, 0x15, 0x17, 0x02, 0x04, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x01, 0x00, 0x03, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x30, 0x0f, 0x00, 0xff,
    // video parameter table for mode 5 (CGA 320x200 4-color)
    0x28, 0x18, 0x08, 0x00, 0x40, 0x0b, 0x03, 0x00, 0x02, 0x23, 0x37, 0x27,
    0x2d, 0x37, 0x30, 0x14, 0x04, 0x11, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
    ...
    0x30, 0x0f, 0x00, 0xff,
    // video parameter table for mode 6 (CGA 640x200 2-color)
    0x50, 0x18, 0x08, 0x00, 0x40, 0x01, 0x01, 0x00, 0x06, 0x23, 0x70, 0x4f,
    0x59, 0x2d, 0x5e, 0x06, 0x04, 0x11, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xe0, 0x23, 0xc7, 0x28, 0x00, 0xdf, 0xef, 0xc2, 0xff, 0x00,
    0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17, 0x17,
    0x17, 0x17, 0x17, 0x01, 0x00, 0x01, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x0d, 0x00, 0xff,
    // video parameter table for mode 7 (80x25 text MDA emulation)
    0x50, 0x18, 0x0e, 0x00, 0x10, 0x00, 0x03, 0x00, 0x03, 0xa6, 0x60, 0x4f,
    0x56, 0x3a, 0x51, 0x60, 0x70, 0x1f, 0x00, 0x0d, 0x0b, 0x0c, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2e, 0x5d, 0x28, 0x0d, 0x5e, 0x6e, 0xa3, 0xff, 0x00,
    0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x08, 0x10, 0x18, 0x18, 0x18, 0x18,
    0x18, 0x18, 0x18, 0x0e, 0x00, 0x0f, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x0a, 0x00, 0xff,
    // video parameter table for mode 8
    0x28, 0x18, 0x08, 0x00, 0x40, 0x00, 0x00, 0x00, 0x03, 0x23, 0x37, 0x27,
    0x2d, 0x37, 0x31, 0x15, 0x04, 0x11, 0x00, 0x07, 0x06, 0x07, 0x00, 0x00,
    0x00, 0x00, 0xe1, 0x24, 0xc7, 0x14, 0x08, 0xe0, 0xf0, 0xa3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x08, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    0x10, 0x0e, 0x00, 0xff,
    // video parameter table for mode b
    0x50, 0x18, 0x08, 0x00, 0x10, 0x01, 0x04, 0x00, 0x07, 0x23, 0x70, 0x4f,
    0x5c, 0x2f, 0x5f, 0x07, 0x04, 0x11, 0x00, 0x07, 0x06, 0x07, 0x00, 0x00,
    0x00, 0x00, 0xe1, 0x24, 0xc7, 0x28, 0x08, 0xe0, 0xf0, 0xa3, 0xff, 0x00,
    ...
    0x00, 0x04, 0x00, 0xff,
    // video parameter table for mode c
    0x50, 0x18, 0x0e, 0x00, 0x10, 0x00, 0x04, 0x00, 0x07, 0xa6, 0x60, 0x4f,
    0x56, 0x3a, 0x51, 0x60, 0x70, 0x1f, 0x00, 0x0d, 0x0b, 0x0c, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2e, 0x5d, 0x28, 0x0d, 0x5e, 0x6e, 0xa3, 0xff, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x0e, 0x00, 0x0f, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x04, 0x00, 0xff,
    // video parameter table for mode d (EGA 320x200 16-color planar graphics)
    0x28, 0x18, 0x08, 0x00, 0x20, 0x0b, 0x0f, 0x00, 0x06, 0x23, 0x37, 0x27,
    0x2d, 0x37, 0x30, 0x14, 0x04, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xe1, 0x24, 0xc7, 0x14, 0x00, 0xe0, 0xf0, 0xe3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x01, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x05, 0x0f, 0xff,
    // video parameter table for mode e (EGA 640x200 16-color planar graphics)
    0x50, 0x18, 0x08, 0x00, 0x40, 0x01, 0x0f, 0x00, 0x06, 0x23, 0x70, 0x4f,
    0x59, 0x2d, 0x5e, 0x06, 0x04, 0x11, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0xe0, 0x23, 0xc7, 0x28, 0x00, 0xdf, 0xef, 0xe3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07, 0x10, 0x11, 0x12, 0x13, 0x14,
    0x15, 0x16, 0x17, 0x01, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x05, 0x0f, 0xff,
    // video parameter table for mode f (EGA 640x350 monochrone graphics, 64k
    // graphics memory)
    0x50, 0x18, 0x0e, 0x00, 0x80, 0x05, 0x0f, 0x00, 0x00, 0xa2, 0x60, 0x4f,
    0x56, 0x1a, 0x50, 0xe0, 0x70, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2e, 0x5d, 0x14, 0x0d, 0x5e, 0x6e, 0x8b, 0xff, 0x00,
    0x08, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
    0x18, 0x00, 0x00, 0x0b, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x07, 0x0f, 0xff,
    // video parameter table for mode 10 (EGA 640x350 4-color planar graphics,
    // 64k graphics memory)
    0x50, 0x18, 0x0e, 0x00, 0x80, 0x05, 0x0f, 0x00, 0x00, 0xa7, 0x5b, 0x4f,
    0x53, 0x17, 0x50, 0xba, 0x6c, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2b, 0x5d, 0x14, 0x0f, 0x5f, 0x0a, 0x8b, 0xff, 0x00,
    0x01, 0x00, 0x00, 0x04, 0x07, 0x00, 0x00, 0x00, 0x01, 0x00, 0x00, 0x04,
    0x07, 0x00, 0x00, 0x01, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x07, 0x0f, 0xff,
    // video parameter table for mode f (EGA 640x350 monochrome graphics, >64k
    // graphics memory)
    0x50, 0x18, 0x0e, 0x00, 0x80, 0x01, 0x0f, 0x00, 0x06, 0xa2, 0x60, 0x4f,
    0x56, 0x3a, 0x50, 0x60, 0x70, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2e, 0x5d, 0x28, 0x0d, 0x5e, 0x6e, 0xe3, 0xff, 0x00,
    0x08, 0x00, 0x00, 0x18, 0x18, 0x00, 0x00, 0x00, 0x08, 0x00, 0x00, 0x00,
    0x18, 0x00, 0x00, 0x0b, 0x00, 0x05, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x05, 0x0f, 0xff,
    // video parameter table for mode 10 (EGA 640x350 16-color planar graphics,
    // >64k graphics memory)
    0x50, 0x18, 0x0e, 0x00, 0x80, 0x01, 0x0f, 0x00, 0x06, 0xa7, 0x5b, 0x4f,
    0x53, 0x37, 0x52, 0x00, 0x6c, 0x1f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2b, 0x5d, 0x28, 0x0f, 0x5f, 0x0a, 0xe3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39, 0x3a, 0x3b, 0x3c,
    0x3d, 0x3e, 0x3f, 0x01, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x05, 0x0f, 0xff,
    // video parameter table for mode 0 (40x25 text high res grayscale)
    0x28, 0x18, 0x0e, 0x00, 0x08, 0x0b, 0x03, 0x00, 0x03, 0xa7, 0x2d, 0x27,
    0x2b, 0x2d, 0x28, 0x6d, 0x6c, 0x1f, 0x00, 0x0d, 0x06, 0x07, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2b, 0x5d, 0x14, 0x0f, 0x5e, 0x0a, 0xa3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39, 0x3a, 0x3b, 0x3c,
    0x3d, 0x3e, 0x3f, 0x08, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x0e, 0x00, 0xff,
    ...
    0x50, 0x18, 0x0e, 0x00, 0x10, 0x01, 0x03, 0x00, 0x03, 0xa7, 0x5b, 0x4f,
    0x53, 0x37, 0x51, 0x5b, 0x6c, 0x1f, 0x00, 0x0d, 0x06, 0x07, 0x00, 0x00,
    0x00, 0x00, 0x5e, 0x2b, 0x5d, 0x28, 0x0f, 0x5e, 0x0a, 0xa3, 0xff, 0x00,
    0x01, 0x02, 0x03, 0x04, 0x05, 0x14, 0x07, 0x38, 0x39, 0x3a, 0x3b, 0x3c,
    0x3d, 0x3e, 0x3f, 0x08, 0x00, 0x0f, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x10, 0x0e, 0x00, 0xff,
...
Bitu RealToPhys(Bitu x) { return PhysMake((uint16_t)(x >> 16), x & 0xFFFF); }
...
void INT10_SetupBasicVideoParameterTable(void) {
  ...
  if (BIOS_VIDEO_TABLE_LOCATION == ~(0U) ||
      BIOS_VIDEO_TABLE_SIZE != (Bitu)copy_sz) {
    if (rom_bios_vptable_enable) {
      /* TODO: Free previous block */

      BIOS_VIDEO_TABLE_SIZE = (Bitu)copy_sz;
      BIOS_VIDEO_TABLE_LOCATION = (Bitu)PhysToReal416((PhysPt)ROMBIOS_GetMemory(
          (Bitu)copy_sz, "BIOS video table (INT 1Dh)")); /* TODO: make option */
