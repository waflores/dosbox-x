...
#define SS_BUFFER_ALIGN                                                        \
  0xE1 // Buffer not aligned (replaces OLD_MANAGER in Win32)
...
#define SS_MISMATCHED_COMPONENTS                                               \
  0xE7                      // The DLLs/EXEs of ASPI don't version check
#define SS_NO_ADAPTERS 0xE8 // No host adapters to manage
#define SS_INSUFFICIENT_RESOURCES                                              \
  0xE9                           // Couldn't allocate resources needed to init
...
#define HASTAT_OK                                                              \
  0x00                       // Host adapter did not detect an // error
#define HASTAT_SEL_TO 0x11   // Selection Timeout
#define HASTAT_DO_DU 0x12    // Data overrun data underrun
#define HASTAT_BUS_FREE 0x13 // Unexpected bus free
#define HASTAT_PHASE_ERR                                                       \
  0x14 // Target bus phase sequence // failure
#define HASTAT_TIMEOUT                                                         \
  0x09 // Timed out while SRB was waiting to be processed.
#define HASTAT_COMMAND_TIMEOUT 0x0B // Adapter timed out processing SRB.
#define HASTAT_MESSAGE_REJECT                                                  \
  0x0D // While processing SRB, the // adapter received a MESSAGE
