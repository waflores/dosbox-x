...
void self_test(void) {
  ...
  static_assert(allones<uint64_t>() == (uint64_t)0xFFFFFFFFFFFFFFFFULL,
                "whoops");
  ...
  static_assert(bitcount2maskmsb<2u, 1u>() == (3u << (type_bits() - 3u)),
                "whoops");
  ...
  if (sizeof(unsigned long long) >=
      8) { /* we're assuming unsigned long long is at least 64 bits here */
