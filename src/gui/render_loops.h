...
#if defined(SCALERLINEAR)
#if (SCALERHEIGHT > 1)
      BituMove((uint8_t *)(&line0[-SCALER_BLOCKSIZE * SCALERWIDTH]) +
                   render.scale.outPitch,
               WC[0], SCALER_BLOCKSIZE * SCALERWIDTH * PSIZE);
#endif
#if (SCALERHEIGHT > 2)
      BituMove((uint8_t *)(&line0[-SCALER_BLOCKSIZE * SCALERWIDTH]) +
                   render.scale.outPitch * 2,
               WC[1], SCALER_BLOCKSIZE * SCALERWIDTH * PSIZE);
#endif
#if (SCALERHEIGHT > 3)
      BituMove((uint8_t *)(&line0[-SCALER_BLOCKSIZE * SCALERWIDTH]) +
                   render.scale.outPitch * 3,
               WC[2], SCALER_BLOCKSIZE * SCALERWIDTH * PSIZE);
#endif
#if (SCALERHEIGHT > 4)
      BituMove((uint8_t *)(&line0[-SCALER_BLOCKSIZE * SCALERWIDTH]) +
                   render.scale.outPitch * 4,
               WC[3], SCALER_BLOCKSIZE * SCALERWIDTH * PSIZE);
#endif
#endif // defined(SCALERLINEAR)
      break;
    }
