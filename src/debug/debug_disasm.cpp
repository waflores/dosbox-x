...
INLINE UINT32 le_uint32(const void *ptr) {
  const UINT8 *ptr8 = (const UINT8 *)ptr;
  return (UINT32)ptr8[0] | (UINT32)ptr8[1] << 8 | (UINT32)ptr8[2] << 16 |
         (UINT32)ptr8[3] << 24;
}
...
static char const *op386map1[256] = {
    ...
    /* 6 */
    "pusha%d ", "popa%d ", "bound %Gv,%Ma", "arpl %Ew,%Rw", "%pf", "%pg", "%so",
    "%sa", "push %Iv", "imul %Gv,%Ev,%Iv", "push %Ix", "imul %Gv,%Ev,%Ib",
    "insb", "ins%ew", "outsb", "outs%ew",
    /* 7 */
    "jo %Jb", "jno %Jb", "jc %Jb", "jnc %Jb", "je %Jb", "jne %Jb", "jbe %Jb",
    "ja %Jb", "js %Jb", "jns %Jb", "jpe %Jb", "jpo %Jb", "jl %Jb", "jge %Jb",
    "jle %Jb", "jg %Jb",
    /* 8 */
    "%g0 %Eb,%Ib", "%g0 %Ev,%Iv", "%g0 %Eb,%Ib", "%g0 %Ev,%Ix", "test %Eb,%Gb",
    ...
    "cbw", "cwd", "call %Ap", "fwait", "pushf%d ", "popf%d ", "sahf", "lahf",
    /* a */
    "mov al,%Oc", "mov %eax,%Ov", "mov %Oc,al", "mov %Ov,%eax", "%P movsb",
    "%P movs%w", "%P cmpsb", "%P cmps%w ", "test al,%Ib", "test %eax,%Iv",
    "%P stosb", "%P stos%w ", "%P lodsb", "%P lods%w ", "%P scasb",
    "%P scas%w ",
    /* b */
    ...
    /* c */
    "%g1 %Eb,%Ib", "%g1 %Ev,%Ib", "ret %Iw", "ret", "les %Gv,%Mp",
    "lds %Gv,%Mp", "mov %Eb,%Ib", "mov %Ev,%Iv", "enter %Iw,%Ib", "leave",
    "retf %Iw", "retf", "int 03", "int %Ib", "into", "iret",
    /* d */
    "%g1 %Eb,1", "%g1 %Ev,1", "%g1 %Eb,cl", "%g1 %Ev,cl", "aam ; %Ib",
    "aad ; %Ib", "setalc", "%P xlat",
#if 0
...
#endif
    /* e */
    "loopne %Jb", "loope %Jb", "loop %Jb", "j%j cxz %Jb", "in al,%Ib",
    "in %eax,%Ib", "out %Ib,al", "out %Ib,%eax", "call %Jv", "jmp %Jv",
    "jmp %Ap", "jmp %Ks%Jb", "in al,dx", "in %eax,dx", "out dx,al",
    "out dx,%eax",
    /* f */
    "lock %p ", "icebp", "repne %p ", "repe %p ", "hlt", "cmc", "%g2", "%g2",
    "clc", "stc", "cli", "sti", "cld", "std", "%g3", "%g4"};

static char const *second[] = {
    /* 0 */
    "%g5", "%g6", "lar %Gv,%Ew", "lsl %Gv,%Ew", nullptr, "[loadall]", "clts",
    "[loadall]", "invd", "wbinvd", nullptr, "UD2", nullptr, nullptr, nullptr,
    nullptr,
    /* 1 */
    "%x0", "%x0", "%x0", "%x0", "%x0", "%x0", "%x0", "%x0", "%g=", nullptr,
    nullptr, nullptr, nullptr, nullptr, nullptr, nullptr,
    /* 2 */
    "mov %Rd,%Cd", "mov %Rd,%Dd", "mov %Cd,%Rd", "mov %Dd,%Rd", "mov %Rd,%Td",
    nullptr, "mov %Td,%Rd", nullptr, "%x0", "%x0", "%x0", "%x0", "%x0", "%x0",
    "%x0", "%x0",
    /* 3 */
    "wrmsr", "rdtsc", "rdmsr", nullptr, "sysenter", "sysexit", nullptr, nullptr,
    ...
    nullptr, nullptr, "%x0", "%x0", "%x0", "%x0",
    /* 6 */
    "punpcklbw %GM,%EM", "punpcklwd %GM,%EM", "punpckldq %GM,%EM",
    "packsswb %GM,%EM", "pcmpgtb %GM,%EM", "pcmpgtw %GM,%EM", "pcmpgtd %GM,%EM",
    "packuswb %GM,%EM", "punpckhbw %GM,%EM", "punpckhwd %GM,%EM",
    "punpckhdq %GM,%EM", "packssdw %GM,%EM", nullptr, nullptr, "movd %GM,%Ed",
    "movq %GM,%EM",
    /* 7 */
    "pshufw %GM,%EM,%Ib", "%g;", "%g:", "%g9", "pcmpeqb %GM,%EM",
    "pcmpeqw %GM,%EM", "pcmpeqd %GM,%EM", "emms", nullptr, nullptr, nullptr,
    nullptr, nullptr, nullptr, "movd %Ed,%GM", "movq %EM,%GM",
    /* 8 */
    "jo %Jv", "jno %Jv", "jb %Jv", "jnb %Jv", "jz %Jv", "jnz %Jv", "jbe %Jv",
    "ja %Jv", "js %Jv", "jns %Jv", "jp %Jv", "jnp %Jv", "jl %Jv", "jge %Jv",
    "jle %Jv", "jg %Jv",
    /* 9 */
    "seto %Eb", "setno %Eb", "setc %Eb", "setnc %Eb", "setz %Eb", "setnz %Eb",
    "setbe %Eb", "setnbe %Eb", "sets %Eb", "setns %Eb", "setp %Eb", "setnp %Eb",
    "setl %Eb", "setge %Eb", "setle %Eb", "setg %Eb",
    /* a */
    "push fs", "pop fs", "cpuid", "bt %Ev,%Gv", "shld %Ev,%Gv,%Ib",
    "shld %Ev,%Gv,cl", nullptr, nullptr, "push gs", "pop gs", nullptr,
    "bts %Ev,%Gv", "shrd %Ev,%Gv,%Ib", "shrd %Ev,%Gv,cl", "%g<", "imul %Gv,%Ev",
    /* b */
    "cmpxchg %Eb,%Gb", "cmpxchg %Ev,%Gv", "lss %Mp", "btr %Ev,%Gv", "lfs %Mp",
    "lgs %Mp", "movzx %Gv,%Eb", "movzx %Gv,%Ew", nullptr, nullptr,
    "%g7 %Ev,%Ib", "btc %Ev,%Gv", "bsf %Gv,%Ev", "bsr %Gv,%Ev", "movsx %Gv,%Eb",
    "movsx %Gv,%Ew",
    /* c */
    "xadd %Eb,%Gb", "xadd %Ev,%Gv", "%x0", nullptr, "%x0", "%x0", "%x0", "%g8",
    "bswap eax", "bswap ecx", "bswap edx", "bswap ebx", "bswap esp",
    "bswap ebp", "bswap esi", "bswap edi",
    /* d */
    nullptr, "psrlw %GM,%EM", "psrld %GM,%EM", "psrlq %GM,%EM", "paddq %GM,%EM",
    "pmullw %GM,%EM", nullptr, "%x0", "psubusb %GM,%EM", "psubusw %GM,%EM",
    "%x0", "%x0", "paddusb %GM,%EM", "paddusw %GM,%EM", "%x0", "pandn %GM,%EM",
    /* e */
    "%x0", "psraw %GM,%EM", "psrad %GM,%EM", "%x0", "%x0", "%x0", nullptr,
    "%x0", "%x0", "%x0", "%x0", "%x0", "%x0", "%x0", "%x0", "%x0",
    /* f */
    nullptr, "psllw %GM,%EM", "pslld %GM,%EM", "psllq %GM,%EM", nullptr,
    "pmaddwd %GM,%EM", "%x0", "%x0", "psubb %GM,%EM", "psubw %GM,%EM",
    "psubd %GM,%EM", nullptr, "paddb %GM,%EM", "paddw %GM,%EM", "paddd %GM,%EM",
    nullptr};

#define NULLPTRS {nullptr, nullptr, nullptr, nullptr}
static char const *mpgroups[][256][4] =
    {/* mandatory prefix groups SSE instructions, then within NP, 66, F2, F3 */
     /* group 0 */
     {/* 0x00 */ NULLPTRS,
      /* 0x01 */ NULLPTRS,
      /* 0x02 */ NULLPTRS,
      ...
      /* 0x10 */
      {"movups %GX,%EX", "movupd %GX,%EX", "movsd %GX,%EX", "movss %GX,%EX"},
      /* 0x11 */
      {"movups %EX,%GX", "movupd %EX,%GX", "movsd %EX,%GX", "movss %EX,%GX"},
      /* 0x12 */
      {"movlps %GX,%EX", nullptr, nullptr,
       nullptr}, // FIXME: The design of this disassembler does not allow
                 // changing opcode name based on r/m = memory or r/m = reg
      ...
      /* 0x51 */
      {"sqrtps %GX,%EX", "sqrtpd %GX,%EX", "sqrtsd %GX,%EX", "sqrtss %GX,%EX"},
      ...
      /* 0x58 */
      {"addps %GX,%EX", "addpd %GX,%EX", "addsd %GX,%EX", "addss %GX,%EX"},
      /* 0x59 */
      {"mulps %GX,%EX", "mulpd %GX,%EX", "mulsd %GX,%EX", "mulss %GX,%EX"},
      /* 0x5A */ NULLPTRS,
      /* 0x5B */ NULLPTRS,
      /* 0x5C */
      {"subps %GX,%EX", "subpd %GX,%EX", "subsd %GX,%EX", "subss %GX,%EX"},
      /* 0x5D */
      {"minps %GX,%EX", "minpd %GX,%EX", "minsd %GX,%EX", "minss %GX,%EX"},
      /* 0x5E */
      {"divps %GX,%EX", "divpd %GX,%EX", "divsd %GX,%EX", "divss %GX,%EX"},
      /* 0x5F */
      {"maxps %GX,%EX", "maxpd %GX,%EX", "maxsd %GX,%EX", "maxss %GX,%EX"},
      ...
      /* 0xC1 */ NULLPTRS,
      /* 0xC2 */
      {"cmpps %GX,%EX,%Ib", "cmppd %GX,%EX,%Ib", "cmpsd %GX,%EX,%Ib",
       "cmpss %GX,%EX,%Ib"}, // FIXME: The immediate byte specifies a comparison
                             // operator
      /* 0xC3 */ NULLPTRS,
...
static char const *groups[][8] =
    {/* group 0 is group 3 for %Ev set */
     ...
     /* 2 */ /* v   v*/
     {"test %Eq,%Iq", "test %Eq,%Iq", "not %Ec", "neg %Ec", "mul %Ec",
      "imul %Ec", "div %Ec", "idiv %Ec"},
     /* 3 */
     {"inc %Eb", "dec %Eb", nullptr, nullptr, nullptr, nullptr, nullptr,
      "callback %Iw"},
     /* 4 */
     {"inc %Ev", "dec %Ev", "call %Kn%Ev", "call %Kf%Ep", "jmp %Kn%Ev",
      "jmp %Kf%Ep", "push %Ev", nullptr},
     /* 5 */
     {"sldt %Ew", "str %Ew", "lldt %Ew", "ltr %Ew", "verr %Ew", "verw %Ew",
      nullptr, nullptr},
     /* 6 */
     {"sgdt %Ms", "sidt %Ms", "lgdt %Ms", "lidt %Ms", "smsw %Ew", nullptr,
      "lmsw %Ew", "invlpg"},
     /* 7 */
     {nullptr, nullptr, nullptr, nullptr, "bt", "bts", "btr", "btc"},
     /* 8 */
     {nullptr, "cmpxchg8b %EQ", nullptr, nullptr, nullptr, nullptr, nullptr,
      nullptr},
     /* 9 */
     {nullptr, nullptr, "psrlq %EM,%Ib", nullptr, nullptr, nullptr,
      "psllq %EM,%Ib", nullptr},
     /* : (NTS: this is '0'+10 in ASCII) */
     {nullptr, nullptr, "psrld %EM,%Ib", nullptr, "psrad %EM,%Ib", nullptr,
      "pslld %EM,%Ib", nullptr},
     /* ; (NTS: this is '0'+11 in ASCII) */
     {nullptr, nullptr, "psrlw %EM,%Ib", nullptr, "psraw %EM,%Ib", nullptr,
      "psllw %EM,%Ib", nullptr},
     /* < (NTS: this is '0'+12 in ASCII) */
     {"fxsave %EM", "fxrstor %EM", "ldmxcsr %EM", "stmxcsr %EM", nullptr,
      nullptr, nullptr, "sfence"},
...
static char *addr_to_hex(UINT32 addr, int splitup) {
  ...
  if (splitup) {
    if (fp_segment(addr) == 0 ||
        fp_offset(addr) == 0xffff) /* 'coz of wraparound */
...
static void percent(char type, char subtype) {
  ...
  case 'J':                   /* relative IP offset */
    ...
    case 1:
      vofs = (INT8)getbyte();
      name = addr_to_hex(
          (UINT32)vofs + instruction_offset + (UINT32)INSTRUCTION_SIZE, 0);
      break;
    case 2:
    ...
    case 4:
      ...
      name = addr_to_hex((UINT32)vofs + instruction_offset +
  ...
  case 'x':
    /* problem: for SSE opcodes with REPE/REPNE mandatory prefix this code will
     * have already written repne/repe so that needs to be wiped out of the
     * buffer */
    if (last_prefix == MP_F2 || last_prefix == MP_F3)
      ua_backspace_repe();
...
static void ua_str(char const *str) {
  ...
  if (strpbrk(str,
              "CDFGRST")) /* specifiers for registers=>no size 2b specified */
    must_do_size = 0;
...
int DasmLastOperandSize() { return opsize; }
