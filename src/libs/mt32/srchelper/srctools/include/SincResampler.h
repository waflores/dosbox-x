...
ResamplerStage *createSincResampler(const double inputFrequency,
...
namespace Utils {
void computeResampleFactors(unsigned int &upsampleFactor,
...
void windowedSinc(FIRCoefficient kernel[], const unsigned int order,
                  const double fc, const double beta, const double amp);
} // namespace KaizerWindow
