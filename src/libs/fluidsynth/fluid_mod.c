 ...
 */
void fluid_mod_set_dest(fluid_mod_t *mod, int dest) { mod->dest = dest; }
 ...
 * @param mod Modulator
 * @return The primary source value (#fluid_mod_src or a MIDI CC controller
 * value).
 */
int fluid_mod_get_source1(fluid_mod_t *mod) { return mod->src1; }
 ...
 */
int fluid_mod_get_flags1(fluid_mod_t *mod) { return mod->flags1; }

/**
 * Get the secondary source value from a modulator.
 * @param mod Modulator
 * @return The secondary source value (#fluid_mod_src or a MIDI CC controller
 * value).
 */
int fluid_mod_get_source2(fluid_mod_t *mod) { return mod->src2; }
 ...
 */
int fluid_mod_get_flags2(fluid_mod_t *mod) { return mod->flags2; }
 ...
 */
int fluid_mod_get_dest(fluid_mod_t *mod) { return mod->dest; }
...
fluid_real_t fluid_mod_get_value(fluid_mod_t *mod, fluid_channel_t *chan,
   ...
   * */
  if ((mod->src2 == FLUID_MOD_VELOCITY) && (mod->src1 == FLUID_MOD_VELOCITY) &&
      (mod->flags1 == (FLUID_MOD_GC | FLUID_MOD_UNIPOLAR | FLUID_MOD_NEGATIVE |
                       FLUID_MOD_LINEAR)) &&
      (mod->flags2 == (FLUID_MOD_GC | FLUID_MOD_UNIPOLAR | FLUID_MOD_POSITIVE |
                       FLUID_MOD_SWITCH)) &&
 ...
 */
void fluid_mod_delete(fluid_mod_t *mod) { FLUID_FREE(mod); }
...
int fluid_mod_test_identity(fluid_mod_t *mod1, fluid_mod_t *mod2) {
  return mod1->dest == mod2->dest && mod1->src1 == mod2->src1 &&
         mod1->src2 == mod2->src2 && mod1->flags1 == mod2->flags1 &&
