...
/*
 ...
 Oct4.2002 : AS : corrected bug in heap allocation, that caused a crash during
 sequencer free.
*/
 ...
 * @param src DOCME
 */
void fluid_event_set_source(fluid_event_t *evt, short src) { evt->src = src; }
 ...
 * @param dest DOCME
 */
void fluid_event_set_dest(fluid_event_t *evt, short dest) { evt->dest = dest; }
 ...
 */
void fluid_event_note(fluid_event_t *evt, int channel, short key, short vel,
...
void fluid_event_program_select(fluid_event_t *evt, int channel,
                                unsigned int sfont_id, short bank_num,
                                short preset_num) {
 ...
 */
void fluid_event_control_change(fluid_event_t *evt, int channel, short control,
                                short val) {
...
/**
 * Get the event type (#fluid_seq_event_type) field from a sequencer event
 * structure.
 * @param evt Sequencer event structure
 * @return Event type (#fluid_seq_event_type).
 */
int fluid_event_get_type(fluid_event_t *evt) { return evt->type; }
 ...
 */
unsigned int fluid_event_get_time(fluid_event_t *evt) { return evt->time; }
 ...
 * @return DOCME
 */
short fluid_event_get_source(fluid_event_t *evt) { return evt->src; }
 ...
 * @return DOCME
 */
short fluid_event_get_dest(fluid_event_t *evt) { return evt->dest; }
 ...
 */
int fluid_event_get_channel(fluid_event_t *evt) { return evt->channel; }
 ...
 */
short fluid_event_get_key(fluid_event_t *evt) { return evt->key; }
 ...
 */
short fluid_event_get_control(fluid_event_t *evt) { return evt->control; }
 ...
 */
short fluid_event_get_value(fluid_event_t *evt) { return evt->value; }
 ...
 */
void *fluid_event_get_data(fluid_event_t *evt) { return evt->data; }
 ...
 * event types.
 */
short fluid_event_get_bank(fluid_event_t *evt) { return evt->control; }
 ...
 */
int fluid_event_get_pitch(fluid_event_t *evt) { return evt->pitch; }
 ...
 * event types.
 */
short fluid_event_get_program(fluid_event_t *evt) { return evt->value; }
