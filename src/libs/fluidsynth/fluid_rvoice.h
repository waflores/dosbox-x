...
struct _fluid_rvoice_dsp_t {
  ...
  fluid_real_t amp_incr; /* amplitude increment value for the next FLUID_BUFSIZE
                            samples */

  fluid_phase_t
      phase; /* the phase (current sample offset) of the sample wave */
  fluid_real_t
      phase_incr; /* the phase increment for the next FLUID_BUFSIZE samples */
  int is_looping;
};
...
void fluid_rvoice_set_root_pitch_hz(fluid_rvoice_t *voice,
                                    fluid_real_t root_pitch_hz);
