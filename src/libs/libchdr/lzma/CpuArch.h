...
#if defined(_M_ARM64) || defined(_M_ARM64EC) || defined(__AARCH64EL__) ||      \
    defined(__AARCH64EB__) || defined(__aarch64__)
#define MY_CPU_ARM64
...
#if defined(__ppc64__) || defined(__powerpc64__) || defined(_LP64) ||          \
    defined(__64BIT__)
#ifdef __ILP32__
...
#define Z7_BSWAP32_CONST(v)                                                    \
  ((((UInt32)(v) << 24)) | (((UInt32)(v) << 8) & (UInt32)0xff0000) |           \
   (((UInt32)(v) >> 8) & (UInt32)0xff00) | (((UInt32)(v) >> 24)))

#if defined(_MSC_VER) && (_MSC_VER >= 1300)

#include <stdlib.h>

/* Note: these macros will use bswap instruction (486), that is unsupported in
 * 386 cpu */
...
problem-2 : 32-bit kernels and arm64 kernels:
  32-bit linux kernels provide fixup for these "paired" instruction "Alignment
fault exception". So unaligned paired-access instructions work via exception
handler in kernel in 32-bit linux.
...
problem-4 : performace:
  ...
  Also unaligned paired-access instructions will be slow, if kernel handles
them.
*/
// it must be disabled:
// #define MY_CPU_LE_UNALIGN
