...
static const FASTCOVER_accel_t
    FASTCOVER_defaultAccelParameters[FASTCOVER_MAX_ACCEL + 1] = {
        {100, 0}, /* accel = 0, should not happen because accel = 0 defaults to
                     accel = 1 */
        {100, 0}, /* accel = 1 */
        {50, 1},  /* accel = 2 */
        {34, 2},  /* accel = 3 */
...
static COVER_segment_t FASTCOVER_selectSegment(const FASTCOVER_ctx_t *ctx,
  ...
  while (activeSegment.end < end) {
    ...
    /* Add frequency of this index to score if this is the first occurrence of
     * index in active segment */
...
ZDICTLIB_STATIC_API size_t ZDICT_trainFromBuffer_fastCover(
  ...
  /* Initialize context */
  {
    size_t const initVal = FASTCOVER_ctx_init(
        &ctx, samplesBuffer, samplesSizes, nbSamples, coverParams.d,
  ...
  for (d = kMinD; d <= kMaxD; d += 2) {
    ...
    LOCALDISPLAYLEVEL(displayLevel, 3, "d=%u\n", d);
    {
      size_t const initVal =
          FASTCOVER_ctx_init(&ctx, samplesBuffer, samplesSizes, nbSamples, d,
