...
// proc_mech
//
// Process a mechanical command - encoded form for computer-computer
// communication. Minimal feedback.
//
...
void GameLink::InitTerminal() { g_p_outbuf = nullptr; }

void GameLink::ExecTerminalMech(Buffer *p_procbuf) {
  proc_mech(p_procbuf, p_procbuf->payload);
}

void GameLink::ExecTerminal(Buffer *p_inbuf, Buffer *p_outbuf,
                            Buffer *p_procbuf) {
