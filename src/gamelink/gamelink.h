...
extern int In(sSharedMMapInput_R2 *p_input, sSharedMMapAudio_R1 *p_audio);

extern void Out(const uint16_t frame_width, const uint16_t frame_height,
                const double source_ratio, const bool need_mouse,
