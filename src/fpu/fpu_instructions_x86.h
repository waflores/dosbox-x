...
#ifdef WEAK_EXCEPTIONS
#define FPUD_LOAD_EA(op, szI, szA) __asm {							\
		__asm	op		szI PTR fpu.p_regs[128].m1 }
#else
...
#define FPUD_SINCOS()                                                          \
  ...
  __asm__ volatile(                                                            \
      ...
      "fstpt		%1				\n"                                                        \
      "1:							"                                                              \
      : "=m"(new_sw), "+m"(fpu.p_regs[TOP]), "=m"(fpu.p_regs[(TOP - 1) & 7])   \
      :                                                                        \
      : "ax", "cc");                                                           \
  fpu.sw = (new_sw & sw_mask) | (fpu.sw & ~FPUStatusWord::conditionMask);      \
  if (!fpu.sw.C2)                                                              \
...
static void FPU_FSIN(void) { FPUD_TRIG(fsin) }

static void FPU_FSINCOS(void) { FPUD_SINCOS() }

static void FPU_FCOS(void) { FPUD_TRIG(fcos) }

static void FPU_FSQRT(void) { FPUD_ARITH2(fsqrt) }

static void FPU_FPATAN(void) { FPUD_WITH_POP(fpatan) }

static void FPU_FPTAN(void) { FPUD_PTAN() }

static void FPU_FADD(Bitu op1, Bitu op2) { FPUD_ARITH1(faddp) }

static void FPU_FADD_EA(Bitu op1) { FPUD_ARITH1_EA(faddp) }

static void FPU_FDIV(Bitu op1, Bitu op2) { FPUD_ARITH3(fdivp) }

static void FPU_FDIV_EA(Bitu op1) { FPUD_ARITH3_EA(fdivp) }

static void FPU_FDIVR(Bitu op1, Bitu op2) { FPUD_ARITH3(fdivrp) }

static void FPU_FDIVR_EA(Bitu op1) { FPUD_ARITH3_EA(fdivrp) }

static void FPU_FMUL(Bitu op1, Bitu op2) { FPUD_ARITH1(fmulp) }

static void FPU_FMUL_EA(Bitu op1) { FPUD_ARITH1_EA(fmulp) }

static void FPU_FSUB(Bitu op1, Bitu op2) { FPUD_ARITH1(fsubp) }

static void FPU_FSUB_EA(Bitu op1) { FPUD_ARITH1_EA(fsubp) }

static void FPU_FSUBR(Bitu op1, Bitu op2) { FPUD_ARITH1(fsubrp) }

static void FPU_FSUBR_EA(Bitu op1) { FPUD_ARITH1_EA(fsubrp) }
...
static void FPU_FUCOMI(Bitu st, Bitu other) {
  ...
  if (fpu.sw & (1u << 14u) /*C3*/) { // if(fpu.regs[st].d == fpu.regs[other].d){
    ...
    return;
             ...
             (1u << 8u) /*C0*/) { // if(fpu.regs[st].d < fpu.regs[other].d){
    SETFLAGBIT(ZF, false);
    SETFLAGBIT(PF, false);
    SETFLAGBIT(CF, true);
    return;
...
static void FPU_FRNDINT(void) { FPUD_ARITH2(frndint) }

static void FPU_FPREM(void) { FPUD_REMAINDER(fprem) }

static void FPU_FPREM1(void) { FPUD_REMAINDER(fprem1) }
...
static void FPU_F2XM1(void) { FPUD_TRIG(f2xm1) }

static void FPU_FYL2X(void) { FPUD_FYL2X(fyl2x) }

static void FPU_FYL2XP1(void) { FPUD_WITH_POP(fyl2xp1) }

static void FPU_FSCALE(void) { FPUD_REMAINDER(fscale) }
...
static void FPU_FXTRACT(void) { FPUD_XTRACT }

static void FPU_FCHS(void) { FPUD_TRIG(fchs) }

static void FPU_FABS(void) { FPUD_TRIG(fabs) }

static void FPU_FTST(void) { FPUD_EXAMINE(ftst) }

static void FPU_FLD1(void) { FPUD_LOAD_CONST(fld1) }

static void FPU_FLDL2T(void) { FPUD_LOAD_CONST(fldl2t) }

static void FPU_FLDL2E(void) { FPUD_LOAD_CONST(fldl2e) }

static void FPU_FLDPI(void) { FPUD_LOAD_CONST(fldpi) }

static void FPU_FLDLG2(void) { FPUD_LOAD_CONST(fldlg2) }

static void FPU_FLDLN2(void) { FPUD_LOAD_CONST(fldln2) }
